...
main() {
  ...
  test('testWalletSignatureExistingWallet', () {
    ...
    expect(Encoding.toHex(signature),
    ...
    expect(Encoding.toHex(signature..removeLast()),
  ...
  test('testWalletSignatureValid', () {
    ...
    final validSignature = Crypto.verify(
        signature, hashData, account.publicKey.uncompressedPublicKey);
