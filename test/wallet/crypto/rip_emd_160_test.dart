...
main() {
  test('encode', () {
    var data = const Utf8Encoder()
        .convert("The quick brown fox jumps over the lazy dog");
    var encodedData =
        Encoding.fromHex("37f332f68db77bd9d7edd4969571ad671cf9dd3b");
    var ripemd = Hash.ripEmd160(data);
    expect(ripemd, encodedData);

    data = const Utf8Encoder()
        .convert("The quick brown fox jumps over the lazy cog");
  ...
  test('empty', () {
    ...
    var encodedData =
        Encoding.fromHex("9c1185a5c5e9fc54612808977ee8f548b2258d31");
    var ripemd = Hash.ripEmd160(data);
    expect(ripemd, encodedData);
  });
}
