...
import 'package:provenance_dart/src/wallet_connect/relay.dart' as _i6;
...
class _FakeEncryptionPayload_1 extends _i1.Fake
    implements _i3.EncryptionPayload {}

class _FakeJsonRpcBase_2 extends _i1.Fake implements _i3.JsonRpcBase {}
...
class MockWebSocket extends _i1.Mock implements _i4.WebSocket {
  ...
  @override
  _i2.Future<dynamic> get last => (super.noSuchMethod(Invocation.getter(#last),
      returnValue: Future<dynamic>.value()) as _i2.Future<dynamic>);
  @override
  ...
  @override
  _i2.StreamSubscription<dynamic> listen(void Function(dynamic)? onData,
  ...
  _i2.Stream<E> asyncExpand<E>(_i2.Stream<E>? Function(dynamic)? convert) =>
      (super.noSuchMethod(Invocation.method(#asyncExpand, [convert]),
          returnValue: Stream<E>.empty()) as _i2.Stream<E>);
  @override
  _i2.Stream<dynamic> handleError(Function? onError,
  ...
  _i2.Stream<dynamic> distinct([bool Function(dynamic, dynamic)? equals]) =>
      (super.noSuchMethod(Invocation.method(#distinct, [equals]),
          returnValue: Stream<dynamic>.empty()) as _i2.Stream<dynamic>);
  @override
  _i2.Future<dynamic> firstWhere(bool Function(dynamic)? test,
          {dynamic Function()? orElse}) =>
      (super.noSuchMethod(
          Invocation.method(#firstWhere, [test], {#orElse: orElse}),
          returnValue: Future<dynamic>.value()) as _i2.Future<dynamic>);
  @override
  _i2.Future<dynamic> lastWhere(bool Function(dynamic)? test,
          {dynamic Function()? orElse}) =>
      (super.noSuchMethod(
          Invocation.method(#lastWhere, [test], {#orElse: orElse}),
          returnValue: Future<dynamic>.value()) as _i2.Future<dynamic>);
  @override
  _i2.Future<dynamic> singleWhere(bool Function(dynamic)? test,
          {dynamic Function()? orElse}) =>
      (super.noSuchMethod(
  ...
  _i2.Future<dynamic> elementAt(int? index) =>
      (super.noSuchMethod(Invocation.method(#elementAt, [index]),
          returnValue: Future<dynamic>.value()) as _i2.Future<dynamic>);
  @override
  _i2.Stream<dynamic> timeout(Duration? timeLimit,
...
class MockEncryptedPayloadHelper extends _i1.Mock
    implements _i5.EncryptedPayloadHelper {
  ...
  _i3.EncryptionPayload encrypt(_i3.JsonRpcBase? encodable) =>
      (super.noSuchMethod(Invocation.method(#encrypt, [encodable]),
          returnValue: _FakeEncryptionPayload_1()) as _i3.EncryptionPayload);
  @override
  _i3.JsonRpcBase decryptAndVerify(_i3.EncryptionPayload? encryptionPayload) =>
      (super.noSuchMethod(
          Invocation.method(#decryptAndVerify, [encryptionPayload]),
          returnValue: _FakeJsonRpcBase_2()) as _i3.JsonRpcBase);
}

/// A class which mocks [RelayDelegate].
///
/// See the documentation for Mockito's code generation for more information.
class MockRelayDelegate extends _i1.Mock implements _i6.RelayDelegate {
  MockRelayDelegate() {
    _i1.throwOnMissingStub(this);
  }

  @override
  void onStatusUpdated(_i6.RelayStatus? relayStatus) =>
      super.noSuchMethod(Invocation.method(#onStatusUpdated, [relayStatus]),
          returnValueForMissingStub: null);
  @override
  void onSubscribe(String? subscribedTopic) =>
      super.noSuchMethod(Invocation.method(#onSubscribe, [subscribedTopic]),
          returnValueForMissingStub: null);
  @override
  void onJsonRpc(String? topic, _i3.JsonRpcBase? jsonRpc) =>
      super.noSuchMethod(Invocation.method(#onJsonRpc, [topic, jsonRpc]),
          returnValueForMissingStub: null);
  @override
