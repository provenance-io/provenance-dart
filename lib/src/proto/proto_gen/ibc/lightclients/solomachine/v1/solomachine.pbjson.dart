...
final $typed_data.Uint8List dataTypeDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List clientStateDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List consensusStateDescriptor = $convert.base64Decode(
    'Cg5Db25zZW5zdXNTdGF0ZRJKCgpwdWJsaWNfa2V5GAEgASgLMhQuZ29vZ2xlLnByb3RvYnVmLkFueUIV8t4fEXlhbWw6InB1YmxpY19rZXkiUglwdWJsaWNLZXkSIAoLZGl2ZXJzaWZpZXIYAiABKAlSC2RpdmVyc2lmaWVyEhwKCXRpbWVzdGFtcBgDIAEoBFIJdGltZXN0YW1wOgSIoB8A');
...
final $typed_data.Uint8List headerDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List misbehaviourDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List signatureAndDataDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List timestampedSignatureDataDescriptor =
    $convert.base64Decode(
        'ChhUaW1lc3RhbXBlZFNpZ25hdHVyZURhdGESQAoOc2lnbmF0dXJlX2RhdGEYASABKAxCGfLeHxV5YW1sOiJzaWduYXR1cmVfZGF0YSJSDXNpZ25hdHVyZURhdGESHAoJdGltZXN0YW1wGAIgASgEUgl0aW1lc3RhbXA6BIigHwA=');
...
final $typed_data.Uint8List signBytesDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List headerDataDescriptor = $convert.base64Decode(
    'CgpIZWFkZXJEYXRhEkwKC25ld19wdWJfa2V5GAEgASgLMhQuZ29vZ2xlLnByb3RvYnVmLkFueUIW8t4fEnlhbWw6Im5ld19wdWJfa2V5IlIJbmV3UHViS2V5EkMKD25ld19kaXZlcnNpZmllchgCIAEoCUIa8t4fFnlhbWw6Im5ld19kaXZlcnNpZmllciJSDm5ld0RpdmVyc2lmaWVyOgSIoB8A');
...
final $typed_data.Uint8List clientStateDataDescriptor = $convert.base64Decode(
    'Cg9DbGllbnRTdGF0ZURhdGESEgoEcGF0aBgBIAEoDFIEcGF0aBJQCgxjbGllbnRfc3RhdGUYAiABKAsyFC5nb29nbGUucHJvdG9idWYuQW55Qhfy3h8TeWFtbDoiY2xpZW50X3N0YXRlIlILY2xpZW50U3RhdGU6BIigHwA=');
...
final $typed_data.Uint8List consensusStateDataDescriptor = $convert.base64Decode(
    'ChJDb25zZW5zdXNTdGF0ZURhdGESEgoEcGF0aBgBIAEoDFIEcGF0aBJZCg9jb25zZW5zdXNfc3RhdGUYAiABKAsyFC5nb29nbGUucHJvdG9idWYuQW55Qhry3h8WeWFtbDoiY29uc2Vuc3VzX3N0YXRlIlIOY29uc2Vuc3VzU3RhdGU6BIigHwA=');
...
final $typed_data.Uint8List connectionStateDataDescriptor = $convert.base64Decode(
    'ChNDb25uZWN0aW9uU3RhdGVEYXRhEhIKBHBhdGgYASABKAxSBHBhdGgSRQoKY29ubmVjdGlvbhgCIAEoCzIlLmliYy5jb3JlLmNvbm5lY3Rpb24udjEuQ29ubmVjdGlvbkVuZFIKY29ubmVjdGlvbjoEiKAfAA==');
...
final $typed_data.Uint8List channelStateDataDescriptor = $convert.base64Decode(
    'ChBDaGFubmVsU3RhdGVEYXRhEhIKBHBhdGgYASABKAxSBHBhdGgSNgoHY2hhbm5lbBgCIAEoCzIcLmliYy5jb3JlLmNoYW5uZWwudjEuQ2hhbm5lbFIHY2hhbm5lbDoEiKAfAA==');
...
final $typed_data.Uint8List packetCommitmentDataDescriptor = $convert.base64Decode(
    'ChRQYWNrZXRDb21taXRtZW50RGF0YRISCgRwYXRoGAEgASgMUgRwYXRoEh4KCmNvbW1pdG1lbnQYAiABKAxSCmNvbW1pdG1lbnQ=');
...
final $typed_data.Uint8List packetAcknowledgementDataDescriptor =
    $convert.base64Decode(
        'ChlQYWNrZXRBY2tub3dsZWRnZW1lbnREYXRhEhIKBHBhdGgYASABKAxSBHBhdGgSKAoPYWNrbm93bGVkZ2VtZW50GAIgASgMUg9hY2tub3dsZWRnZW1lbnQ=');
...
final $typed_data.Uint8List nextSequenceRecvDataDescriptor = $convert.base64Decode(
    'ChROZXh0U2VxdWVuY2VSZWN2RGF0YRISCgRwYXRoGAEgASgMUgRwYXRoEjwKDW5leHRfc2VxX3JlY3YYAiABKARCGPLeHxR5YW1sOiJuZXh0X3NlcV9yZWN2IlILbmV4dFNlcVJlY3Y=');
