...
class MsgConnectionOpenInit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgConnectionOpenInit', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.connection.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1.Counterparty>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'counterparty', subBuilder: $1.Counterparty.create)
    ..aOM<$1.Version>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', subBuilder: $1.Version.create)
  ...
  @$pb.TagNumber(2)
  set counterparty($1.Counterparty v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class MsgConnectionOpenTry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgConnectionOpenTry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.connection.v1'), createEmptyInstance: create)
    ...
    ..aOM<$2.Any>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientState', subBuilder: $2.Any.create)
    ...
    ..pc<$1.Version>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'counterpartyVersions', $pb.PbFieldType.PM, subBuilder: $1.Version.create)
    ..aOM<$3.Height>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight', subBuilder: $3.Height.create)
    ...
    ..aOM<$3.Height>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusHeight', subBuilder: $3.Height.create)
  ...
  @$pb.TagNumber(3)
  set clientState($2.Any v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(7)
  set proofHeight($3.Height v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(11)
  set consensusHeight($3.Height v) { setField(11, v); }
  @$pb.TagNumber(11)
...
class MsgConnectionOpenAck extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgConnectionOpenAck', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.connection.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1.Version>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', subBuilder: $1.Version.create)
    ..aOM<$2.Any>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientState', subBuilder: $2.Any.create)
    ..aOM<$3.Height>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight', subBuilder: $3.Height.create)
    ...
    ..aOM<$3.Height>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusHeight', subBuilder: $3.Height.create)
  ...
  @$pb.TagNumber(4)
  set clientState($2.Any v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set proofHeight($3.Height v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(9)
  set consensusHeight($3.Height v) { setField(9, v); }
  @$pb.TagNumber(9)
