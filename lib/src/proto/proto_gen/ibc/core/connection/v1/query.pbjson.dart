...
final $typed_data.Uint8List queryConnectionRequestDescriptor =
    $convert.base64Decode(
        'ChZRdWVyeUNvbm5lY3Rpb25SZXF1ZXN0EiMKDWNvbm5lY3Rpb25faWQYASABKAlSDGNvbm5lY3Rpb25JZA==');
...
final $typed_data.Uint8List queryConnectionResponseDescriptor =
    $convert.base64Decode(
        'ChdRdWVyeUNvbm5lY3Rpb25SZXNwb25zZRJFCgpjb25uZWN0aW9uGAEgASgLMiUuaWJjLmNvcmUuY29ubmVjdGlvbi52MS5Db25uZWN0aW9uRW5kUgpjb25uZWN0aW9uEhQKBXByb29mGAIgASgMUgVwcm9vZhJDCgxwcm9vZl9oZWlnaHQYAyABKAsyGi5pYmMuY29yZS5jbGllbnQudjEuSGVpZ2h0QgTI3h8AUgtwcm9vZkhlaWdodA==');
...
final $typed_data.Uint8List queryConnectionsRequestDescriptor =
    $convert.base64Decode(
        'ChdRdWVyeUNvbm5lY3Rpb25zUmVxdWVzdBJGCgpwYWdpbmF0aW9uGAEgASgLMiYuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVxdWVzdFIKcGFnaW5hdGlvbg==');
...
final $typed_data.Uint8List queryConnectionsResponseDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List queryClientConnectionsRequestDescriptor =
    $convert.base64Decode(
        'Ch1RdWVyeUNsaWVudENvbm5lY3Rpb25zUmVxdWVzdBIbCgljbGllbnRfaWQYASABKAlSCGNsaWVudElk');
...
final $typed_data.Uint8List queryClientConnectionsResponseDescriptor =
    $convert.base64Decode(
        'Ch5RdWVyeUNsaWVudENvbm5lY3Rpb25zUmVzcG9uc2USKQoQY29ubmVjdGlvbl9wYXRocxgBIAMoCVIPY29ubmVjdGlvblBhdGhzEhQKBXByb29mGAIgASgMUgVwcm9vZhJDCgxwcm9vZl9oZWlnaHQYAyABKAsyGi5pYmMuY29yZS5jbGllbnQudjEuSGVpZ2h0QgTI3h8AUgtwcm9vZkhlaWdodA==');
...
final $typed_data.Uint8List queryConnectionClientStateRequestDescriptor =
    $convert.base64Decode(
        'CiFRdWVyeUNvbm5lY3Rpb25DbGllbnRTdGF0ZVJlcXVlc3QSPQoNY29ubmVjdGlvbl9pZBgBIAEoCUIY8t4fFHlhbWw6ImNvbm5lY3Rpb25faWQiUgxjb25uZWN0aW9uSWQ=');
...
final $typed_data.Uint8List queryConnectionClientStateResponseDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List queryConnectionConsensusStateRequestDescriptor =
    $convert.base64Decode(
        'CiRRdWVyeUNvbm5lY3Rpb25Db25zZW5zdXNTdGF0ZVJlcXVlc3QSPQoNY29ubmVjdGlvbl9pZBgBIAEoCUIY8t4fFHlhbWw6ImNvbm5lY3Rpb25faWQiUgxjb25uZWN0aW9uSWQSJwoPcmV2aXNpb25fbnVtYmVyGAIgASgEUg5yZXZpc2lvbk51bWJlchInCg9yZXZpc2lvbl9oZWlnaHQYAyABKARSDnJldmlzaW9uSGVpZ2h0');
...
final $typed_data.Uint8List queryConnectionConsensusStateResponseDescriptor =
    $convert.base64Decode(
        '');
