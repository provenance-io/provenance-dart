...
final $typed_data.Uint8List merklePrefixDescriptor = $convert.base64Decode(
    'CgxNZXJrbGVQcmVmaXgSNAoKa2V5X3ByZWZpeBgBIAEoDEIV8t4fEXlhbWw6ImtleV9wcmVmaXgiUglrZXlQcmVmaXg=');
...
final $typed_data.Uint8List merklePathDescriptor = $convert.base64Decode(
    'CgpNZXJrbGVQYXRoEi4KCGtleV9wYXRoGAEgAygJQhPy3h8PeWFtbDoia2V5X3BhdGgiUgdrZXlQYXRoOgSYoB8A');
...
final $typed_data.Uint8List merkleProofDescriptor = $convert.base64Decode(
    'CgtNZXJrbGVQcm9vZhIuCgZwcm9vZnMYASADKAsyFi5pY3MyMy5Db21taXRtZW50UHJvb2ZSBnByb29mcw==');
