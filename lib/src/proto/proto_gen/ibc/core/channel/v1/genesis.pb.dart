...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.channel.v1'), createEmptyInstance: create)
    ..pc<$0.IdentifiedChannel>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'channels', $pb.PbFieldType.PM, subBuilder: $0.IdentifiedChannel.create)
    ..pc<$0.PacketState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'acknowledgements', $pb.PbFieldType.PM, subBuilder: $0.PacketState.create)
    ..pc<$0.PacketState>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commitments', $pb.PbFieldType.PM, subBuilder: $0.PacketState.create)
    ..pc<$0.PacketState>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'receipts', $pb.PbFieldType.PM, subBuilder: $0.PacketState.create)
