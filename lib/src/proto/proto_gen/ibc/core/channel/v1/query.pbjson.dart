...
final $typed_data.Uint8List queryChannelRequestDescriptor = $convert.base64Decode(
    'ChNRdWVyeUNoYW5uZWxSZXF1ZXN0EhcKB3BvcnRfaWQYASABKAlSBnBvcnRJZBIdCgpjaGFubmVsX2lkGAIgASgJUgljaGFubmVsSWQ=');
...
final $typed_data.Uint8List queryChannelResponseDescriptor = $convert.base64Decode(
    'ChRRdWVyeUNoYW5uZWxSZXNwb25zZRI2CgdjaGFubmVsGAEgASgLMhwuaWJjLmNvcmUuY2hhbm5lbC52MS5DaGFubmVsUgdjaGFubmVsEhQKBXByb29mGAIgASgMUgVwcm9vZhJDCgxwcm9vZl9oZWlnaHQYAyABKAsyGi5pYmMuY29yZS5jbGllbnQudjEuSGVpZ2h0QgTI3h8AUgtwcm9vZkhlaWdodA==');
...
final $typed_data.Uint8List queryChannelsRequestDescriptor = $convert.base64Decode(
    'ChRRdWVyeUNoYW5uZWxzUmVxdWVzdBJGCgpwYWdpbmF0aW9uGAEgASgLMiYuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVxdWVzdFIKcGFnaW5hdGlvbg==');
...
final $typed_data.Uint8List queryChannelsResponseDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List queryConnectionChannelsRequestDescriptor =
    $convert.base64Decode(
        'Ch5RdWVyeUNvbm5lY3Rpb25DaGFubmVsc1JlcXVlc3QSHgoKY29ubmVjdGlvbhgBIAEoCVIKY29ubmVjdGlvbhJGCgpwYWdpbmF0aW9uGAIgASgLMiYuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVxdWVzdFIKcGFnaW5hdGlvbg==');
...
final $typed_data.Uint8List queryConnectionChannelsResponseDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List queryChannelClientStateRequestDescriptor =
    $convert.base64Decode(
        'Ch5RdWVyeUNoYW5uZWxDbGllbnRTdGF0ZVJlcXVlc3QSFwoHcG9ydF9pZBgBIAEoCVIGcG9ydElkEh0KCmNoYW5uZWxfaWQYAiABKAlSCWNoYW5uZWxJZA==');
...
final $typed_data.Uint8List queryChannelClientStateResponseDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List queryChannelConsensusStateRequestDescriptor =
    $convert.base64Decode(
        'CiFRdWVyeUNoYW5uZWxDb25zZW5zdXNTdGF0ZVJlcXVlc3QSFwoHcG9ydF9pZBgBIAEoCVIGcG9ydElkEh0KCmNoYW5uZWxfaWQYAiABKAlSCWNoYW5uZWxJZBInCg9yZXZpc2lvbl9udW1iZXIYAyABKARSDnJldmlzaW9uTnVtYmVyEicKD3JldmlzaW9uX2hlaWdodBgEIAEoBFIOcmV2aXNpb25IZWlnaHQ=');
...
final $typed_data.Uint8List queryChannelConsensusStateResponseDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List queryPacketCommitmentRequestDescriptor =
    $convert.base64Decode(
        'ChxRdWVyeVBhY2tldENvbW1pdG1lbnRSZXF1ZXN0EhcKB3BvcnRfaWQYASABKAlSBnBvcnRJZBIdCgpjaGFubmVsX2lkGAIgASgJUgljaGFubmVsSWQSGgoIc2VxdWVuY2UYAyABKARSCHNlcXVlbmNl');
...
final $typed_data.Uint8List queryPacketCommitmentResponseDescriptor =
    $convert.base64Decode(
        'Ch1RdWVyeVBhY2tldENvbW1pdG1lbnRSZXNwb25zZRIeCgpjb21taXRtZW50GAEgASgMUgpjb21taXRtZW50EhQKBXByb29mGAIgASgMUgVwcm9vZhJDCgxwcm9vZl9oZWlnaHQYAyABKAsyGi5pYmMuY29yZS5jbGllbnQudjEuSGVpZ2h0QgTI3h8AUgtwcm9vZkhlaWdodA==');
...
final $typed_data.Uint8List queryPacketCommitmentsRequestDescriptor =
    $convert.base64Decode(
        'Ch1RdWVyeVBhY2tldENvbW1pdG1lbnRzUmVxdWVzdBIXCgdwb3J0X2lkGAEgASgJUgZwb3J0SWQSHQoKY2hhbm5lbF9pZBgCIAEoCVIJY2hhbm5lbElkEkYKCnBhZ2luYXRpb24YAyABKAsyJi5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXF1ZXN0UgpwYWdpbmF0aW9u');
...
final $typed_data.Uint8List queryPacketCommitmentsResponseDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List queryPacketReceiptRequestDescriptor =
    $convert.base64Decode(
        'ChlRdWVyeVBhY2tldFJlY2VpcHRSZXF1ZXN0EhcKB3BvcnRfaWQYASABKAlSBnBvcnRJZBIdCgpjaGFubmVsX2lkGAIgASgJUgljaGFubmVsSWQSGgoIc2VxdWVuY2UYAyABKARSCHNlcXVlbmNl');
...
final $typed_data.Uint8List queryPacketReceiptResponseDescriptor =
    $convert.base64Decode(
        'ChpRdWVyeVBhY2tldFJlY2VpcHRSZXNwb25zZRIaCghyZWNlaXZlZBgCIAEoCFIIcmVjZWl2ZWQSFAoFcHJvb2YYAyABKAxSBXByb29mEkMKDHByb29mX2hlaWdodBgEIAEoCzIaLmliYy5jb3JlLmNsaWVudC52MS5IZWlnaHRCBMjeHwBSC3Byb29mSGVpZ2h0');
...
final $typed_data.Uint8List queryPacketAcknowledgementRequestDescriptor =
    $convert.base64Decode(
        'CiFRdWVyeVBhY2tldEFja25vd2xlZGdlbWVudFJlcXVlc3QSFwoHcG9ydF9pZBgBIAEoCVIGcG9ydElkEh0KCmNoYW5uZWxfaWQYAiABKAlSCWNoYW5uZWxJZBIaCghzZXF1ZW5jZRgDIAEoBFIIc2VxdWVuY2U=');
...
final $typed_data.Uint8List queryPacketAcknowledgementResponseDescriptor =
    $convert.base64Decode(
        'CiJRdWVyeVBhY2tldEFja25vd2xlZGdlbWVudFJlc3BvbnNlEigKD2Fja25vd2xlZGdlbWVudBgBIAEoDFIPYWNrbm93bGVkZ2VtZW50EhQKBXByb29mGAIgASgMUgVwcm9vZhJDCgxwcm9vZl9oZWlnaHQYAyABKAsyGi5pYmMuY29yZS5jbGllbnQudjEuSGVpZ2h0QgTI3h8AUgtwcm9vZkhlaWdodA==');
...
final $typed_data.Uint8List queryPacketAcknowledgementsRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List queryPacketAcknowledgementsResponseDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List queryUnreceivedPacketsRequestDescriptor =
    $convert.base64Decode(
        'Ch1RdWVyeVVucmVjZWl2ZWRQYWNrZXRzUmVxdWVzdBIXCgdwb3J0X2lkGAEgASgJUgZwb3J0SWQSHQoKY2hhbm5lbF9pZBgCIAEoCVIJY2hhbm5lbElkEj4KG3BhY2tldF9jb21taXRtZW50X3NlcXVlbmNlcxgDIAMoBFIZcGFja2V0Q29tbWl0bWVudFNlcXVlbmNlcw==');
...
final $typed_data.Uint8List queryUnreceivedPacketsResponseDescriptor =
    $convert.base64Decode(
        'Ch5RdWVyeVVucmVjZWl2ZWRQYWNrZXRzUmVzcG9uc2USHAoJc2VxdWVuY2VzGAEgAygEUglzZXF1ZW5jZXMSOAoGaGVpZ2h0GAIgASgLMhouaWJjLmNvcmUuY2xpZW50LnYxLkhlaWdodEIEyN4fAFIGaGVpZ2h0');
...
final $typed_data.Uint8List queryUnreceivedAcksRequestDescriptor =
    $convert.base64Decode(
        'ChpRdWVyeVVucmVjZWl2ZWRBY2tzUmVxdWVzdBIXCgdwb3J0X2lkGAEgASgJUgZwb3J0SWQSHQoKY2hhbm5lbF9pZBgCIAEoCVIJY2hhbm5lbElkEjAKFHBhY2tldF9hY2tfc2VxdWVuY2VzGAMgAygEUhJwYWNrZXRBY2tTZXF1ZW5jZXM=');
...
final $typed_data.Uint8List queryUnreceivedAcksResponseDescriptor =
    $convert.base64Decode(
        'ChtRdWVyeVVucmVjZWl2ZWRBY2tzUmVzcG9uc2USHAoJc2VxdWVuY2VzGAEgAygEUglzZXF1ZW5jZXMSOAoGaGVpZ2h0GAIgASgLMhouaWJjLmNvcmUuY2xpZW50LnYxLkhlaWdodEIEyN4fAFIGaGVpZ2h0');
...
final $typed_data.Uint8List queryNextSequenceReceiveRequestDescriptor =
    $convert.base64Decode(
        'Ch9RdWVyeU5leHRTZXF1ZW5jZVJlY2VpdmVSZXF1ZXN0EhcKB3BvcnRfaWQYASABKAlSBnBvcnRJZBIdCgpjaGFubmVsX2lkGAIgASgJUgljaGFubmVsSWQ=');
...
final $typed_data.Uint8List queryNextSequenceReceiveResponseDescriptor =
    $convert.base64Decode(
        'CiBRdWVyeU5leHRTZXF1ZW5jZVJlY2VpdmVSZXNwb25zZRIyChVuZXh0X3NlcXVlbmNlX3JlY2VpdmUYASABKARSE25leHRTZXF1ZW5jZVJlY2VpdmUSFAoFcHJvb2YYAiABKAxSBXByb29mEkMKDHByb29mX2hlaWdodBgDIAEoCzIaLmliYy5jb3JlLmNsaWVudC52MS5IZWlnaHRCBMjeHwBSC3Byb29mSGVpZ2h0');
