...
final $typed_data.Uint8List stateDescriptor = $convert.base64Decode(
    'CgVTdGF0ZRI2Ch9TVEFURV9VTklOSVRJQUxJWkVEX1VOU1BFQ0lGSUVEEAAaEYqdIA1VTklOSVRJQUxJWkVEEhgKClNUQVRFX0lOSVQQARoIip0gBElOSVQSHgoNU1RBVEVfVFJZT1BFThACGguKnSAHVFJZT1BFThIYCgpTVEFURV9PUEVOEAMaCIqdIARPUEVOEhwKDFNUQVRFX0NMT1NFRBAEGgqKnSAGQ0xPU0VEGgSIox4A');
...
final $typed_data.Uint8List orderDescriptor = $convert.base64Decode(
    'CgVPcmRlchIkChZPUkRFUl9OT05FX1VOU1BFQ0lGSUVEEAAaCIqdIAROT05FEiIKD09SREVSX1VOT1JERVJFRBABGg2KnSAJVU5PUkRFUkVEEh4KDU9SREVSX09SREVSRUQQAhoLip0gB09SREVSRUQaBIijHgA=');
...
final $typed_data.Uint8List channelDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List identifiedChannelDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List counterpartyDescriptor = $convert.base64Decode(
    'CgxDb3VudGVycGFydHkSKwoHcG9ydF9pZBgBIAEoCUIS8t4fDnlhbWw6InBvcnRfaWQiUgZwb3J0SWQSNAoKY2hhbm5lbF9pZBgCIAEoCUIV8t4fEXlhbWw6ImNoYW5uZWxfaWQiUgljaGFubmVsSWQ6BIigHwA=');
...
final $typed_data.Uint8List acknowledgementDescriptor = $convert.base64Decode(
    'Cg9BY2tub3dsZWRnZW1lbnQSGAoGcmVzdWx0GBUgASgMSABSBnJlc3VsdBIWCgVlcnJvchgWIAEoCUgAUgVlcnJvckIKCghyZXNwb25zZQ==');
