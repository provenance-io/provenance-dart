...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..pc<$0.IdentifiedClientState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clients', $pb.PbFieldType.PM, subBuilder: $0.IdentifiedClientState.create)
    ..pc<$0.ClientConsensusStates>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientsConsensus', $pb.PbFieldType.PM, subBuilder: $0.ClientConsensusStates.create)
