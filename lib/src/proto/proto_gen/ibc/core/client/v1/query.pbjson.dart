...
final $typed_data.Uint8List queryClientStateResponseDescriptor =
    $convert.base64Decode(
        'ChhRdWVyeUNsaWVudFN0YXRlUmVzcG9uc2USNwoMY2xpZW50X3N0YXRlGAEgASgLMhQuZ29vZ2xlLnByb3RvYnVmLkFueVILY2xpZW50U3RhdGUSFAoFcHJvb2YYAiABKAxSBXByb29mEkMKDHByb29mX2hlaWdodBgDIAEoCzIaLmliYy5jb3JlLmNsaWVudC52MS5IZWlnaHRCBMjeHwBSC3Byb29mSGVpZ2h0');
...
final $typed_data.Uint8List queryClientStatesRequestDescriptor =
    $convert.base64Decode(
        'ChhRdWVyeUNsaWVudFN0YXRlc1JlcXVlc3QSRgoKcGFnaW5hdGlvbhgBIAEoCzImLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlcXVlc3RSCnBhZ2luYXRpb24=');
...
final $typed_data.Uint8List queryClientStatesResponseDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List queryConsensusStateRequestDescriptor =
    $convert.base64Decode(
        'ChpRdWVyeUNvbnNlbnN1c1N0YXRlUmVxdWVzdBIbCgljbGllbnRfaWQYASABKAlSCGNsaWVudElkEicKD3JldmlzaW9uX251bWJlchgCIAEoBFIOcmV2aXNpb25OdW1iZXISJwoPcmV2aXNpb25faGVpZ2h0GAMgASgEUg5yZXZpc2lvbkhlaWdodBIjCg1sYXRlc3RfaGVpZ2h0GAQgASgIUgxsYXRlc3RIZWlnaHQ=');
...
final $typed_data.Uint8List queryConsensusStateResponseDescriptor =
    $convert.base64Decode(
        'ChtRdWVyeUNvbnNlbnN1c1N0YXRlUmVzcG9uc2USPQoPY29uc2Vuc3VzX3N0YXRlGAEgASgLMhQuZ29vZ2xlLnByb3RvYnVmLkFueVIOY29uc2Vuc3VzU3RhdGUSFAoFcHJvb2YYAiABKAxSBXByb29mEkMKDHByb29mX2hlaWdodBgDIAEoCzIaLmliYy5jb3JlLmNsaWVudC52MS5IZWlnaHRCBMjeHwBSC3Byb29mSGVpZ2h0');
...
final $typed_data.Uint8List queryConsensusStatesRequestDescriptor =
    $convert.base64Decode(
        'ChtRdWVyeUNvbnNlbnN1c1N0YXRlc1JlcXVlc3QSGwoJY2xpZW50X2lkGAEgASgJUghjbGllbnRJZBJGCgpwYWdpbmF0aW9uGAIgASgLMiYuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVxdWVzdFIKcGFnaW5hdGlvbg==');
...
final $typed_data.Uint8List queryClientParamsResponseDescriptor =
    $convert.base64Decode(
        'ChlRdWVyeUNsaWVudFBhcmFtc1Jlc3BvbnNlEjIKBnBhcmFtcxgBIAEoCzIaLmliYy5jb3JlLmNsaWVudC52MS5QYXJhbXNSBnBhcmFtcw==');
...
final $typed_data.Uint8List queryUpgradedClientStateResponseDescriptor =
    $convert.base64Decode(
        'CiBRdWVyeVVwZ3JhZGVkQ2xpZW50U3RhdGVSZXNwb25zZRJIChV1cGdyYWRlZF9jbGllbnRfc3RhdGUYASABKAsyFC5nb29nbGUucHJvdG9idWYuQW55UhN1cGdyYWRlZENsaWVudFN0YXRl');
