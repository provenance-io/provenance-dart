...
final $typed_data.Uint8List eventMsgFeeDescriptor = $convert.base64Decode('CgtFdmVudE1zZ0ZlZRIZCghtc2dfdHlwZRgBIAEoCVIHbXNnVHlwZRIUCgVjb3VudBgCIAEoCVIFY291bnQSFAoFdG90YWwYAyABKAlSBXRvdGFs');
@$core.Deprecated('Use eventMsgFeesDescriptor instead')
const EventMsgFees$json = const {
  '1': 'EventMsgFees',
  '2': const [
    const {'1': 'msg_fees', '3': 1, '4': 3, '5': 11, '6': '.provenance.msgfees.v1.EventMsgFee', '8': const {}, '10': 'msgFees'},
  ],
};

/// Descriptor for `EventMsgFees`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List eventMsgFeesDescriptor = $convert.base64Decode('CgxFdmVudE1zZ0ZlZXMSQwoIbXNnX2ZlZXMYASADKAsyIi5wcm92ZW5hbmNlLm1zZ2ZlZXMudjEuRXZlbnRNc2dGZWVCBMjeHwBSB21zZ0ZlZXM=');
