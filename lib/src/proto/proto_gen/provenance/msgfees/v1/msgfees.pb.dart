...
class EventMsgFee extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventMsgFee', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'provenance.msgfees.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'msgType')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'count')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'total')
    ..hasRequiredFields = false
  ;
  ...
  factory EventMsgFee.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EventMsgFee.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EventMsgFee copyWith(void Function(EventMsgFee) updates) => super.copyWith((message) => updates(message as EventMsgFee)) as EventMsgFee; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static EventMsgFee getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EventMsgFee>(create);
  ...
  @$pb.TagNumber(2)
  set count($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
...
class EventMsgFees extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventMsgFees', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'provenance.msgfees.v1'), createEmptyInstance: create)
    ..pc<EventMsgFee>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'msgFees', $pb.PbFieldType.PM, subBuilder: EventMsgFee.create)
    ..hasRequiredFields = false
  ;
  ...
  factory EventMsgFees.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EventMsgFees.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EventMsgFees copyWith(void Function(EventMsgFees) updates) => super.copyWith((message) => updates(message as EventMsgFees)) as EventMsgFees; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static EventMsgFees create() => EventMsgFees._();
  EventMsgFees createEmptyInstance() => create();
  static $pb.PbList<EventMsgFees> createRepeated() => $pb.PbList<EventMsgFees>();
  @$core.pragma('dart2js:noInline')
  static EventMsgFees getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EventMsgFees>(create);
