...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'provenance.name.v1'), createEmptyInstance: create)
    ..aOM<$0.Params>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params', subBuilder: $0.Params.create)
    ..pc<$0.NameRecord>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bindings', $pb.PbFieldType.PM, subBuilder: $0.NameRecord.create)
