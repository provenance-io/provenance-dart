...
final $typed_data.Uint8List msgAddAttributeRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgAddAttributeResponseDescriptor = $convert.base64Decode('ChdNc2dBZGRBdHRyaWJ1dGVSZXNwb25zZQ==');
...
const MsgUpdateAttributeRequest$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'original_value', '3': 2, '4': 1, '5': 12, '10': 'originalValue'},
    const {'1': 'update_value', '3': 3, '4': 1, '5': 12, '10': 'updateValue'},
    const {'1': 'original_attribute_type', '3': 4, '4': 1, '5': 14, '6': '.provenance.attribute.v1.AttributeType', '10': 'originalAttributeType'},
    const {'1': 'update_attribute_type', '3': 5, '4': 1, '5': 14, '6': '.provenance.attribute.v1.AttributeType', '10': 'updateAttributeType'},
...
final $typed_data.Uint8List msgUpdateAttributeRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgUpdateAttributeResponseDescriptor = $convert.base64Decode('ChpNc2dVcGRhdGVBdHRyaWJ1dGVSZXNwb25zZQ==');
...
final $typed_data.Uint8List msgDeleteAttributeRequestDescriptor = $convert.base64Decode('ChlNc2dEZWxldGVBdHRyaWJ1dGVSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWUSGAoHYWNjb3VudBgCIAEoCVIHYWNjb3VudBIUCgVvd25lchgDIAEoCVIFb3duZXI6EOigHwCYoB8AgNwgAIigHwA=');
...
final $typed_data.Uint8List msgDeleteAttributeResponseDescriptor = $convert.base64Decode('ChpNc2dEZWxldGVBdHRyaWJ1dGVSZXNwb25zZQ==');
...
final $typed_data.Uint8List msgDeleteDistinctAttributeRequestDescriptor = $convert.base64Decode('CiFNc2dEZWxldGVEaXN0aW5jdEF0dHJpYnV0ZVJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRIUCgV2YWx1ZRgCIAEoDFIFdmFsdWUSGAoHYWNjb3VudBgDIAEoCVIHYWNjb3VudBIUCgVvd25lchgEIAEoCVIFb3duZXI6EOigHwCYoB8AgNwgAIigHwA=');
...
final $typed_data.Uint8List msgDeleteDistinctAttributeResponseDescriptor = $convert.base64Decode('CiJNc2dEZWxldGVEaXN0aW5jdEF0dHJpYnV0ZVJlc3BvbnNl');
