...
class Scope extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Scope', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'provenance.metadata.v1'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scopeId', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'specificationId', $pb.PbFieldType.OY)
    ..pc<Party>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'owners', $pb.PbFieldType.PM, subBuilder: Party.create)
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataAccess')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'valueOwnerAddress')
  ...
  @$pb.TagNumber(2)
  set specificationId($core.List<$core.int> v) { $_setBytes(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(5)
  set valueOwnerAddress($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
...
class Session extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Session', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'provenance.metadata.v1'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sessionId', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'specificationId', $pb.PbFieldType.OY)
    ..pc<Party>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parties', $pb.PbFieldType.PM, subBuilder: Party.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..a<$core.List<$core.int>>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'context', $pb.PbFieldType.OY)
    ..aOM<AuditFields>(99, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audit', subBuilder: AuditFields.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set context($core.List<$core.int> v) { $_setBytes(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(99)
  set audit(AuditFields v) { setField(99, v); }
  @$pb.TagNumber(99)
...
class Record extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Record', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'provenance.metadata.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..a<$core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sessionId', $pb.PbFieldType.OY)
    ...
    ..pc<RecordOutput>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputs', $pb.PbFieldType.PM, subBuilder: RecordOutput.create)
    ..a<$core.List<$core.int>>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'specificationId', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  set specificationId($core.List<$core.int> v) { $_setBytes(5, v); }
  @$pb.TagNumber(6)
...
class Process extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Process', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'provenance.metadata.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
  ...
  Process_ProcessId whichProcessId() => _Process_ProcessIdByTag[$_whichOneof(0)]!;
...
class RecordInput extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, RecordInput_Source> _RecordInput_SourceByTag = {
    2 : RecordInput_Source.recordId,
    3 : RecordInput_Source.hash,
    0 : RecordInput_Source.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RecordInput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'provenance.metadata.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..a<$core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recordId', $pb.PbFieldType.OY)
    ...
    ..e<RecordInputStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: RecordInputStatus.RECORD_INPUT_STATUS_UNSPECIFIED, valueOf: RecordInputStatus.valueOf, enumValues: RecordInputStatus.values)
    ..hasRequiredFields = false
  ;
  ...
  RecordInput_Source whichSource() => _RecordInput_SourceByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(5)
  set status(RecordInputStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class RecordOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RecordOutput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'provenance.metadata.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hash')
    ..e<ResultStatus>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: ResultStatus.RESULT_STATUS_UNSPECIFIED, valueOf: ResultStatus.valueOf, enumValues: ResultStatus.values)
    ..hasRequiredFields = false
  ;
  ...
  factory RecordOutput.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RecordOutput.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RecordOutput copyWith(void Function(RecordOutput) updates) => super.copyWith((message) => updates(message as RecordOutput)) as RecordOutput; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RecordOutput create() => RecordOutput._();
  RecordOutput createEmptyInstance() => create();
  static $pb.PbList<RecordOutput> createRepeated() => $pb.PbList<RecordOutput>();
  @$core.pragma('dart2js:noInline')
  static RecordOutput getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RecordOutput>(create);
  ...
  @$pb.TagNumber(2)
  set status(ResultStatus v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Party extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Party', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'provenance.metadata.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'address')
    ..e<$1.PartyType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'role', $pb.PbFieldType.OE, defaultOrMaker: $1.PartyType.PARTY_TYPE_UNSPECIFIED, valueOf: $1.PartyType.valueOf, enumValues: $1.PartyType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set role($1.PartyType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class AuditFields extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuditFields', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'provenance.metadata.v1'), createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createdDate', subBuilder: $0.Timestamp.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createdBy')
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updatedDate', subBuilder: $0.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  set createdDate($0.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set updatedDate($0.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
