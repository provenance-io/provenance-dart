...
final $typed_data.Uint8List eventTxCompletedDescriptor = $convert.base64Decode('ChBFdmVudFR4Q29tcGxldGVkEhYKBm1vZHVsZRgBIAEoCVIGbW9kdWxlEhoKCGVuZHBvaW50GAIgASgJUghlbmRwb2ludBIYCgdzaWduZXJzGAMgAygJUgdzaWduZXJz');
...
final $typed_data.Uint8List eventScopeCreatedDescriptor = $convert.base64Decode('ChFFdmVudFNjb3BlQ3JlYXRlZBIdCgpzY29wZV9hZGRyGAEgASgJUglzY29wZUFkZHI=');
...
final $typed_data.Uint8List eventScopeUpdatedDescriptor = $convert.base64Decode('ChFFdmVudFNjb3BlVXBkYXRlZBIdCgpzY29wZV9hZGRyGAEgASgJUglzY29wZUFkZHI=');
...
final $typed_data.Uint8List eventScopeDeletedDescriptor = $convert.base64Decode('ChFFdmVudFNjb3BlRGVsZXRlZBIdCgpzY29wZV9hZGRyGAEgASgJUglzY29wZUFkZHI=');
...
final $typed_data.Uint8List eventSessionCreatedDescriptor = $convert.base64Decode('ChNFdmVudFNlc3Npb25DcmVhdGVkEiEKDHNlc3Npb25fYWRkchgBIAEoCVILc2Vzc2lvbkFkZHISHQoKc2NvcGVfYWRkchgCIAEoCVIJc2NvcGVBZGRy');
...
final $typed_data.Uint8List eventSessionUpdatedDescriptor = $convert.base64Decode('ChNFdmVudFNlc3Npb25VcGRhdGVkEiEKDHNlc3Npb25fYWRkchgBIAEoCVILc2Vzc2lvbkFkZHISHQoKc2NvcGVfYWRkchgCIAEoCVIJc2NvcGVBZGRy');
...
final $typed_data.Uint8List eventSessionDeletedDescriptor = $convert.base64Decode('ChNFdmVudFNlc3Npb25EZWxldGVkEiEKDHNlc3Npb25fYWRkchgBIAEoCVILc2Vzc2lvbkFkZHISHQoKc2NvcGVfYWRkchgCIAEoCVIJc2NvcGVBZGRy');
...
final $typed_data.Uint8List eventRecordCreatedDescriptor = $convert.base64Decode('ChJFdmVudFJlY29yZENyZWF0ZWQSHwoLcmVjb3JkX2FkZHIYASABKAlSCnJlY29yZEFkZHISIQoMc2Vzc2lvbl9hZGRyGAIgASgJUgtzZXNzaW9uQWRkchIdCgpzY29wZV9hZGRyGAMgASgJUglzY29wZUFkZHI=');
...
final $typed_data.Uint8List eventRecordUpdatedDescriptor = $convert.base64Decode('ChJFdmVudFJlY29yZFVwZGF0ZWQSHwoLcmVjb3JkX2FkZHIYASABKAlSCnJlY29yZEFkZHISIQoMc2Vzc2lvbl9hZGRyGAIgASgJUgtzZXNzaW9uQWRkchIdCgpzY29wZV9hZGRyGAMgASgJUglzY29wZUFkZHI=');
...
final $typed_data.Uint8List eventRecordDeletedDescriptor = $convert.base64Decode('ChJFdmVudFJlY29yZERlbGV0ZWQSHwoLcmVjb3JkX2FkZHIYASABKAlSCnJlY29yZEFkZHISHQoKc2NvcGVfYWRkchgDIAEoCVIJc2NvcGVBZGRy');
...
const EventScopeSpecificationCreated$json = const {
  ...
  '2': const [
    const {'1': 'scope_specification_addr', '3': 1, '4': 1, '5': 9, '10': 'scopeSpecificationAddr'},
  ],
};

/// Descriptor for `EventScopeSpecificationCreated`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List eventScopeSpecificationCreatedDescriptor = $convert.base64Decode('Ch5FdmVudFNjb3BlU3BlY2lmaWNhdGlvbkNyZWF0ZWQSOAoYc2NvcGVfc3BlY2lmaWNhdGlvbl9hZGRyGAEgASgJUhZzY29wZVNwZWNpZmljYXRpb25BZGRy');
...
final $typed_data.Uint8List eventScopeSpecificationUpdatedDescriptor = $convert.base64Decode('Ch5FdmVudFNjb3BlU3BlY2lmaWNhdGlvblVwZGF0ZWQSOAoYc2NvcGVfc3BlY2lmaWNhdGlvbl9hZGRyGAEgASgJUhZzY29wZVNwZWNpZmljYXRpb25BZGRy');
...
final $typed_data.Uint8List eventScopeSpecificationDeletedDescriptor = $convert.base64Decode('Ch5FdmVudFNjb3BlU3BlY2lmaWNhdGlvbkRlbGV0ZWQSOAoYc2NvcGVfc3BlY2lmaWNhdGlvbl9hZGRyGAEgASgJUhZzY29wZVNwZWNpZmljYXRpb25BZGRy');
...
const EventContractSpecificationCreated$json = const {
  ...
  '2': const [
    const {'1': 'contract_specification_addr', '3': 1, '4': 1, '5': 9, '10': 'contractSpecificationAddr'},
  ],
};

/// Descriptor for `EventContractSpecificationCreated`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List eventContractSpecificationCreatedDescriptor = $convert.base64Decode('CiFFdmVudENvbnRyYWN0U3BlY2lmaWNhdGlvbkNyZWF0ZWQSPgobY29udHJhY3Rfc3BlY2lmaWNhdGlvbl9hZGRyGAEgASgJUhljb250cmFjdFNwZWNpZmljYXRpb25BZGRy');
...
final $typed_data.Uint8List eventContractSpecificationUpdatedDescriptor = $convert.base64Decode('CiFFdmVudENvbnRyYWN0U3BlY2lmaWNhdGlvblVwZGF0ZWQSPgobY29udHJhY3Rfc3BlY2lmaWNhdGlvbl9hZGRyGAEgASgJUhljb250cmFjdFNwZWNpZmljYXRpb25BZGRy');
...
final $typed_data.Uint8List eventContractSpecificationDeletedDescriptor = $convert.base64Decode('CiFFdmVudENvbnRyYWN0U3BlY2lmaWNhdGlvbkRlbGV0ZWQSPgobY29udHJhY3Rfc3BlY2lmaWNhdGlvbl9hZGRyGAEgASgJUhljb250cmFjdFNwZWNpZmljYXRpb25BZGRy');
...
const EventRecordSpecificationCreated$json = const {
  ...
  '2': const [
    const {'1': 'record_specification_addr', '3': 1, '4': 1, '5': 9, '10': 'recordSpecificationAddr'},
    const {'1': 'contract_specification_addr', '3': 2, '4': 1, '5': 9, '10': 'contractSpecificationAddr'},
  ],
};

/// Descriptor for `EventRecordSpecificationCreated`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List eventRecordSpecificationCreatedDescriptor = $convert.base64Decode('Ch9FdmVudFJlY29yZFNwZWNpZmljYXRpb25DcmVhdGVkEjoKGXJlY29yZF9zcGVjaWZpY2F0aW9uX2FkZHIYASABKAlSF3JlY29yZFNwZWNpZmljYXRpb25BZGRyEj4KG2NvbnRyYWN0X3NwZWNpZmljYXRpb25fYWRkchgCIAEoCVIZY29udHJhY3RTcGVjaWZpY2F0aW9uQWRkcg==');
...
final $typed_data.Uint8List eventRecordSpecificationUpdatedDescriptor = $convert.base64Decode('Ch9FdmVudFJlY29yZFNwZWNpZmljYXRpb25VcGRhdGVkEjoKGXJlY29yZF9zcGVjaWZpY2F0aW9uX2FkZHIYASABKAlSF3JlY29yZFNwZWNpZmljYXRpb25BZGRyEj4KG2NvbnRyYWN0X3NwZWNpZmljYXRpb25fYWRkchgCIAEoCVIZY29udHJhY3RTcGVjaWZpY2F0aW9uQWRkcg==');
...
final $typed_data.Uint8List eventRecordSpecificationDeletedDescriptor = $convert.base64Decode('Ch9FdmVudFJlY29yZFNwZWNpZmljYXRpb25EZWxldGVkEjoKGXJlY29yZF9zcGVjaWZpY2F0aW9uX2FkZHIYASABKAlSF3JlY29yZFNwZWNpZmljYXRpb25BZGRyEj4KG2NvbnRyYWN0X3NwZWNpZmljYXRpb25fYWRkchgCIAEoCVIZY29udHJhY3RTcGVjaWZpY2F0aW9uQWRkcg==');
...
final $typed_data.Uint8List eventOSLocatorCreatedDescriptor = $convert.base64Decode('ChVFdmVudE9TTG9jYXRvckNyZWF0ZWQSFAoFb3duZXIYASABKAlSBW93bmVy');
...
final $typed_data.Uint8List eventOSLocatorUpdatedDescriptor = $convert.base64Decode('ChVFdmVudE9TTG9jYXRvclVwZGF0ZWQSFAoFb3duZXIYASABKAlSBW93bmVy');
...
final $typed_data.Uint8List eventOSLocatorDeletedDescriptor = $convert.base64Decode('ChVFdmVudE9TTG9jYXRvckRlbGV0ZWQSFAoFb3duZXIYASABKAlSBW93bmVy');
