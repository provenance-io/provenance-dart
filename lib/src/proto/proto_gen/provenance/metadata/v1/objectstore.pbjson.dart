...
final $typed_data.Uint8List objectStoreLocatorDescriptor = $convert.base64Decode('ChJPYmplY3RTdG9yZUxvY2F0b3ISFAoFb3duZXIYASABKAlSBW93bmVyEh8KC2xvY2F0b3JfdXJpGAIgASgJUgpsb2NhdG9yVXJpEiUKDmVuY3J5cHRpb25fa2V5GAMgASgJUg1lbmNyeXB0aW9uS2V5');
@$core.Deprecated('Use oSLocatorParamsDescriptor instead')
const OSLocatorParams$json = const {
  '1': 'OSLocatorParams',
  '2': const [
    const {'1': 'max_uri_length', '3': 1, '4': 1, '5': 13, '8': const {}, '10': 'maxUriLength'},
  ],
};

/// Descriptor for `OSLocatorParams`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List oSLocatorParamsDescriptor = $convert.base64Decode('Cg9PU0xvY2F0b3JQYXJhbXMSTQoObWF4X3VyaV9sZW5ndGgYASABKA1CJ9reHwZ1aW50MzLI3h8A8t4fFXlhbWw6Im1heF91cmlfbGVuZ3RoIlIMbWF4VXJpTGVuZ3Ro');
