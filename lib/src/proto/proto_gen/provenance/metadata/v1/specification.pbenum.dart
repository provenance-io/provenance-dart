...
class DefinitionType extends $pb.ProtobufEnum {
  static const DefinitionType DEFINITION_TYPE_UNSPECIFIED = DefinitionType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DEFINITION_TYPE_UNSPECIFIED');
  static const DefinitionType DEFINITION_TYPE_PROPOSED = DefinitionType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DEFINITION_TYPE_PROPOSED');
  static const DefinitionType DEFINITION_TYPE_RECORD = DefinitionType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DEFINITION_TYPE_RECORD');
  static const DefinitionType DEFINITION_TYPE_RECORD_LIST = DefinitionType._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DEFINITION_TYPE_RECORD_LIST');
  ...
  static final $core.Map<$core.int, DefinitionType> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class PartyType extends $pb.ProtobufEnum {
  static const PartyType PARTY_TYPE_UNSPECIFIED = PartyType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PARTY_TYPE_UNSPECIFIED');
