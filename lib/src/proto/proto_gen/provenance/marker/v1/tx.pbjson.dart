...
const MsgAddMarkerRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'status', '3': 5, '4': 1, '5': 14, '6': '.provenance.marker.v1.MarkerStatus', '10': 'status'},
    const {'1': 'marker_type', '3': 6, '4': 1, '5': 14, '6': '.provenance.marker.v1.MarkerType', '10': 'markerType'},
    const {'1': 'access_list', '3': 7, '4': 3, '5': 11, '6': '.provenance.marker.v1.AccessGrant', '8': const {}, '10': 'accessList'},
...
final $typed_data.Uint8List msgAddMarkerRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgAddMarkerResponseDescriptor = $convert.base64Decode('ChRNc2dBZGRNYXJrZXJSZXNwb25zZQ==');
...
const MsgAddAccessRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'access', '3': 3, '4': 3, '5': 11, '6': '.provenance.marker.v1.AccessGrant', '8': const {}, '10': 'access'},
  ],
};

/// Descriptor for `MsgAddAccessRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List msgAddAccessRequestDescriptor = $convert.base64Decode('ChNNc2dBZGRBY2Nlc3NSZXF1ZXN0EhQKBWRlbm9tGAEgASgJUgVkZW5vbRIkCg1hZG1pbmlzdHJhdG9yGAIgASgJUg1hZG1pbmlzdHJhdG9yEj8KBmFjY2VzcxgDIAMoCzIhLnByb3ZlbmFuY2UubWFya2VyLnYxLkFjY2Vzc0dyYW50QgTI3h8AUgZhY2Nlc3M=');
...
final $typed_data.Uint8List msgAddAccessResponseDescriptor = $convert.base64Decode('ChRNc2dBZGRBY2Nlc3NSZXNwb25zZQ==');
...
const MsgDeleteAccessRequest$json = const {
  ...
  '2': const [
    const {'1': 'denom', '3': 1, '4': 1, '5': 9, '10': 'denom'},
    const {'1': 'administrator', '3': 2, '4': 1, '5': 9, '10': 'administrator'},
    const {'1': 'removed_address', '3': 3, '4': 1, '5': 9, '10': 'removedAddress'},
  ],
};

/// Descriptor for `MsgDeleteAccessRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List msgDeleteAccessRequestDescriptor = $convert.base64Decode('ChZNc2dEZWxldGVBY2Nlc3NSZXF1ZXN0EhQKBWRlbm9tGAEgASgJUgVkZW5vbRIkCg1hZG1pbmlzdHJhdG9yGAIgASgJUg1hZG1pbmlzdHJhdG9yEicKD3JlbW92ZWRfYWRkcmVzcxgDIAEoCVIOcmVtb3ZlZEFkZHJlc3M=');
...
final $typed_data.Uint8List msgDeleteAccessResponseDescriptor = $convert.base64Decode('ChdNc2dEZWxldGVBY2Nlc3NSZXNwb25zZQ==');
...
final $typed_data.Uint8List msgFinalizeRequestDescriptor = $convert.base64Decode('ChJNc2dGaW5hbGl6ZVJlcXVlc3QSFAoFZGVub20YASABKAlSBWRlbm9tEiQKDWFkbWluaXN0cmF0b3IYAiABKAlSDWFkbWluaXN0cmF0b3I=');
...
final $typed_data.Uint8List msgFinalizeResponseDescriptor = $convert.base64Decode('ChNNc2dGaW5hbGl6ZVJlc3BvbnNl');
...
final $typed_data.Uint8List msgActivateRequestDescriptor = $convert.base64Decode('ChJNc2dBY3RpdmF0ZVJlcXVlc3QSFAoFZGVub20YASABKAlSBWRlbm9tEiQKDWFkbWluaXN0cmF0b3IYAiABKAlSDWFkbWluaXN0cmF0b3I=');
...
final $typed_data.Uint8List msgActivateResponseDescriptor = $convert.base64Decode('ChNNc2dBY3RpdmF0ZVJlc3BvbnNl');
...
final $typed_data.Uint8List msgCancelRequestDescriptor = $convert.base64Decode('ChBNc2dDYW5jZWxSZXF1ZXN0EhQKBWRlbm9tGAEgASgJUgVkZW5vbRIkCg1hZG1pbmlzdHJhdG9yGAIgASgJUg1hZG1pbmlzdHJhdG9y');
...
final $typed_data.Uint8List msgCancelResponseDescriptor = $convert.base64Decode('ChFNc2dDYW5jZWxSZXNwb25zZQ==');
...
final $typed_data.Uint8List msgDeleteRequestDescriptor = $convert.base64Decode('ChBNc2dEZWxldGVSZXF1ZXN0EhQKBWRlbm9tGAEgASgJUgVkZW5vbRIkCg1hZG1pbmlzdHJhdG9yGAIgASgJUg1hZG1pbmlzdHJhdG9y');
...
final $typed_data.Uint8List msgMintRequestDescriptor = $convert.base64Decode('Cg5Nc2dNaW50UmVxdWVzdBJiCgZhbW91bnQYASABKAsyGS5jb3Ntb3MuYmFzZS52MWJldGExLkNvaW5CL8jeHwDa3h8nZ2l0aHViLmNvbS9jb3Ntb3MvY29zbW9zLXNkay90eXBlcy5Db2luUgZhbW91bnQSJAoNYWRtaW5pc3RyYXRvchgCIAEoCVINYWRtaW5pc3RyYXRvcg==');
...
final $typed_data.Uint8List msgMintResponseDescriptor = $convert.base64Decode('Cg9Nc2dNaW50UmVzcG9uc2U=');
...
final $typed_data.Uint8List msgBurnRequestDescriptor = $convert.base64Decode('Cg5Nc2dCdXJuUmVxdWVzdBJiCgZhbW91bnQYASABKAsyGS5jb3Ntb3MuYmFzZS52MWJldGExLkNvaW5CL8jeHwDa3h8nZ2l0aHViLmNvbS9jb3Ntb3MvY29zbW9zLXNkay90eXBlcy5Db2luUgZhbW91bnQSJAoNYWRtaW5pc3RyYXRvchgCIAEoCVINYWRtaW5pc3RyYXRvcg==');
...
final $typed_data.Uint8List msgBurnResponseDescriptor = $convert.base64Decode('Cg9Nc2dCdXJuUmVzcG9uc2U=');
...
final $typed_data.Uint8List msgWithdrawRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgWithdrawResponseDescriptor = $convert.base64Decode('ChNNc2dXaXRoZHJhd1Jlc3BvbnNl');
...
final $typed_data.Uint8List msgTransferRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgSetDenomMetadataRequestDescriptor = $convert.base64Decode('ChpNc2dTZXREZW5vbU1ldGFkYXRhUmVxdWVzdBJ1CghtZXRhZGF0YRgBIAEoCzIdLmNvc21vcy5iYW5rLnYxYmV0YTEuTWV0YWRhdGFCOsjeHwDa3h8yZ2l0aHViLmNvbS9jb3Ntb3MvY29zbW9zLXNkay94L2JhbmsvdHlwZXMuTWV0YWRhdGFSCG1ldGFkYXRhEiQKDWFkbWluaXN0cmF0b3IYAiABKAlSDWFkbWluaXN0cmF0b3I=');
...
final $typed_data.Uint8List msgSetDenomMetadataResponseDescriptor = $convert.base64Decode('ChtNc2dTZXREZW5vbU1ldGFkYXRhUmVzcG9uc2U=');
