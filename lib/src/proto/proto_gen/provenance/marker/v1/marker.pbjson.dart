...
final $typed_data.Uint8List markerTypeDescriptor = $convert.base64Decode(
    'CgpNYXJrZXJUeXBlEigKF01BUktFUl9UWVBFX1VOU1BFQ0lGSUVEEAAaC4qdIAdVbmtub3duEh4KEE1BUktFUl9UWVBFX0NPSU4QARoIip0gBENvaW4SLgoWTUFSS0VSX1RZUEVfUkVTVFJJQ1RFRBACGhKKnSAOUmVzdHJpY3RlZENvaW4=');
...
final $typed_data.Uint8List markerStatusDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List paramsDescriptor = $convert.base64Decode(
    'CgZQYXJhbXMSOAoQbWF4X3RvdGFsX3N1cHBseRgBIAEoBEIO2t4fBnVpbnQ2NMjeHwBSDm1heFRvdGFsU3VwcGx5EisKEWVuYWJsZV9nb3Zlcm5hbmNlGAIgASgIUhBlbmFibGVHb3Zlcm5hbmNlEjgKGHVucmVzdHJpY3RlZF9kZW5vbV9yZWdleBgDIAEoCVIWdW5yZXN0cmljdGVkRGVub21SZWdleDoI6KAfAJigHwA=');
...
final $typed_data.Uint8List markerAccountDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List eventMarkerAddDescriptor = $convert.base64Decode(
    'Cg5FdmVudE1hcmtlckFkZBIUCgVkZW5vbRgBIAEoCVIFZGVub20SFgoGYW1vdW50GAIgASgJUgZhbW91bnQSFgoGc3RhdHVzGAMgASgJUgZzdGF0dXMSGAoHbWFuYWdlchgEIAEoCVIHbWFuYWdlchIfCgttYXJrZXJfdHlwZRgFIAEoCVIKbWFya2VyVHlwZQ==');
...
final $typed_data.Uint8List eventMarkerAddAccessDescriptor = $convert.base64Decode(
    'ChRFdmVudE1hcmtlckFkZEFjY2VzcxJFCgZhY2Nlc3MYASABKAsyJy5wcm92ZW5hbmNlLm1hcmtlci52MS5FdmVudE1hcmtlckFjY2Vzc0IEyN4fAFIGYWNjZXNzEhQKBWRlbm9tGAIgASgJUgVkZW5vbRIkCg1hZG1pbmlzdHJhdG9yGAMgASgJUg1hZG1pbmlzdHJhdG9y');
...
final $typed_data.Uint8List eventMarkerAccessDescriptor = $convert.base64Decode(
    'ChFFdmVudE1hcmtlckFjY2VzcxIYCgdhZGRyZXNzGAEgASgJUgdhZGRyZXNzEiAKC3Blcm1pc3Npb25zGAIgAygJUgtwZXJtaXNzaW9ucw==');
...
final $typed_data.Uint8List eventMarkerDeleteAccessDescriptor =
    $convert.base64Decode(
        'ChdFdmVudE1hcmtlckRlbGV0ZUFjY2VzcxIlCg5yZW1vdmVfYWRkcmVzcxgBIAEoCVINcmVtb3ZlQWRkcmVzcxIUCgVkZW5vbRgCIAEoCVIFZGVub20SJAoNYWRtaW5pc3RyYXRvchgDIAEoCVINYWRtaW5pc3RyYXRvcg==');
...
final $typed_data.Uint8List eventMarkerFinalizeDescriptor = $convert.base64Decode(
    'ChNFdmVudE1hcmtlckZpbmFsaXplEhQKBWRlbm9tGAEgASgJUgVkZW5vbRIkCg1hZG1pbmlzdHJhdG9yGAIgASgJUg1hZG1pbmlzdHJhdG9y');
...
final $typed_data.Uint8List eventMarkerActivateDescriptor = $convert.base64Decode(
    'ChNFdmVudE1hcmtlckFjdGl2YXRlEhQKBWRlbm9tGAEgASgJUgVkZW5vbRIkCg1hZG1pbmlzdHJhdG9yGAIgASgJUg1hZG1pbmlzdHJhdG9y');
...
final $typed_data.Uint8List eventMarkerCancelDescriptor = $convert.base64Decode(
    'ChFFdmVudE1hcmtlckNhbmNlbBIUCgVkZW5vbRgBIAEoCVIFZGVub20SJAoNYWRtaW5pc3RyYXRvchgCIAEoCVINYWRtaW5pc3RyYXRvcg==');
...
final $typed_data.Uint8List eventMarkerDeleteDescriptor = $convert.base64Decode(
    'ChFFdmVudE1hcmtlckRlbGV0ZRIUCgVkZW5vbRgBIAEoCVIFZGVub20SJAoNYWRtaW5pc3RyYXRvchgCIAEoCVINYWRtaW5pc3RyYXRvcg==');
...
final $typed_data.Uint8List eventMarkerMintDescriptor = $convert.base64Decode(
    'Cg9FdmVudE1hcmtlck1pbnQSFgoGYW1vdW50GAEgASgJUgZhbW91bnQSFAoFZGVub20YAiABKAlSBWRlbm9tEiQKDWFkbWluaXN0cmF0b3IYAyABKAlSDWFkbWluaXN0cmF0b3I=');
...
final $typed_data.Uint8List eventMarkerBurnDescriptor = $convert.base64Decode(
    'Cg9FdmVudE1hcmtlckJ1cm4SFgoGYW1vdW50GAEgASgJUgZhbW91bnQSFAoFZGVub20YAiABKAlSBWRlbm9tEiQKDWFkbWluaXN0cmF0b3IYAyABKAlSDWFkbWluaXN0cmF0b3I=');
...
final $typed_data.Uint8List eventMarkerWithdrawDescriptor = $convert.base64Decode(
    'ChNFdmVudE1hcmtlcldpdGhkcmF3EhQKBWNvaW5zGAEgASgJUgVjb2lucxIUCgVkZW5vbRgCIAEoCVIFZGVub20SJAoNYWRtaW5pc3RyYXRvchgDIAEoCVINYWRtaW5pc3RyYXRvchIdCgp0b19hZGRyZXNzGAQgASgJUgl0b0FkZHJlc3M=');
...
final $typed_data.Uint8List eventMarkerTransferDescriptor = $convert.base64Decode(
    'ChNFdmVudE1hcmtlclRyYW5zZmVyEhYKBmFtb3VudBgBIAEoCVIGYW1vdW50EhQKBWRlbm9tGAIgASgJUgVkZW5vbRIkCg1hZG1pbmlzdHJhdG9yGAMgASgJUg1hZG1pbmlzdHJhdG9yEh0KCnRvX2FkZHJlc3MYBCABKAlSCXRvQWRkcmVzcxIhCgxmcm9tX2FkZHJlc3MYBSABKAlSC2Zyb21BZGRyZXNz');
...
final $typed_data.Uint8List eventMarkerSetDenomMetadataDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List eventDenomUnitDescriptor = $convert.base64Decode(
    'Cg5FdmVudERlbm9tVW5pdBIUCgVkZW5vbRgBIAEoCVIFZGVub20SGgoIZXhwb25lbnQYAiABKAlSCGV4cG9uZW50EhgKB2FsaWFzZXMYAyADKAlSB2FsaWFzZXM=');
