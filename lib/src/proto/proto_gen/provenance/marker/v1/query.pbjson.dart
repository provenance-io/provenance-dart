...
const QueryParamsResponse$json = const {
  ...
  '2': const [
    const {'1': 'params', '3': 1, '4': 1, '5': 11, '6': '.provenance.marker.v1.Params', '8': const {}, '10': 'params'},
  ],
};

/// Descriptor for `QueryParamsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryParamsResponseDescriptor = $convert.base64Decode('ChNRdWVyeVBhcmFtc1Jlc3BvbnNlEjoKBnBhcmFtcxgBIAEoCzIcLnByb3ZlbmFuY2UubWFya2VyLnYxLlBhcmFtc0IEyN4fAFIGcGFyYW1z');
...
const QueryAllMarkersRequest$json = const {
  ...
  '2': const [
    const {'1': 'status', '3': 1, '4': 1, '5': 14, '6': '.provenance.marker.v1.MarkerStatus', '10': 'status'},
...
final $typed_data.Uint8List queryAllMarkersRequestDescriptor = $convert.base64Decode('ChZRdWVyeUFsbE1hcmtlcnNSZXF1ZXN0EjoKBnN0YXR1cxgBIAEoDjIiLnByb3ZlbmFuY2UubWFya2VyLnYxLk1hcmtlclN0YXR1c1IGc3RhdHVzEkYKCnBhZ2luYXRpb24YAiABKAsyJi5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXF1ZXN0UgpwYWdpbmF0aW9u');
...
const QueryAllMarkersResponse$json = const {
  ...
  '2': const [
    const {'1': 'markers', '3': 1, '4': 3, '5': 11, '6': '.google.protobuf.Any', '8': const {}, '10': 'markers'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryAllMarkersResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryAllMarkersResponseDescriptor = $convert.base64Decode('ChdRdWVyeUFsbE1hcmtlcnNSZXNwb25zZRJCCgdtYXJrZXJzGAEgAygLMhQuZ29vZ2xlLnByb3RvYnVmLkFueUISyrQtDk1hcmtlckFjY291bnRJUgdtYXJrZXJzEkcKCnBhZ2luYXRpb24YAiABKAsyJy5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXNwb25zZVIKcGFnaW5hdGlvbg==');
...
final $typed_data.Uint8List queryMarkerRequestDescriptor = $convert.base64Decode('ChJRdWVyeU1hcmtlclJlcXVlc3QSDgoCaWQYASABKAlSAmlk');
@$core.Deprecated('Use queryMarkerResponseDescriptor instead')
const QueryMarkerResponse$json = const {
  '1': 'QueryMarkerResponse',
  '2': const [
    const {'1': 'marker', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.Any', '8': const {}, '10': 'marker'},
  ],
};

/// Descriptor for `QueryMarkerResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryMarkerResponseDescriptor = $convert.base64Decode('ChNRdWVyeU1hcmtlclJlc3BvbnNlEkAKBm1hcmtlchgBIAEoCzIULmdvb2dsZS5wcm90b2J1Zi5BbnlCEsq0LQ5NYXJrZXJBY2NvdW50SVIGbWFya2Vy');
...
final $typed_data.Uint8List queryHoldingRequestDescriptor = $convert.base64Decode('ChNRdWVyeUhvbGRpbmdSZXF1ZXN0Eg4KAmlkGAEgASgJUgJpZBJGCgpwYWdpbmF0aW9uGAIgASgLMiYuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVxdWVzdFIKcGFnaW5hdGlvbg==');
@$core.Deprecated('Use queryHoldingResponseDescriptor instead')
const QueryHoldingResponse$json = const {
  '1': 'QueryHoldingResponse',
  '2': const [
    const {'1': 'balances', '3': 1, '4': 3, '5': 11, '6': '.provenance.marker.v1.Balance', '8': const {}, '10': 'balances'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryHoldingResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryHoldingResponseDescriptor = $convert.base64Decode('ChRRdWVyeUhvbGRpbmdSZXNwb25zZRI/CghiYWxhbmNlcxgBIAMoCzIdLnByb3ZlbmFuY2UubWFya2VyLnYxLkJhbGFuY2VCBMjeHwBSCGJhbGFuY2VzEkcKCnBhZ2luYXRpb24YAiABKAsyJy5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXNwb25zZVIKcGFnaW5hdGlvbg==');
...
final $typed_data.Uint8List querySupplyRequestDescriptor = $convert.base64Decode('ChJRdWVyeVN1cHBseVJlcXVlc3QSDgoCaWQYASABKAlSAmlk');
...
final $typed_data.Uint8List querySupplyResponseDescriptor = $convert.base64Decode('ChNRdWVyeVN1cHBseVJlc3BvbnNlEjcKBmFtb3VudBgBIAEoCzIZLmNvc21vcy5iYXNlLnYxYmV0YTEuQ29pbkIEyN4fAFIGYW1vdW50');
...
final $typed_data.Uint8List queryEscrowRequestDescriptor = $convert.base64Decode('ChJRdWVyeUVzY3Jvd1JlcXVlc3QSDgoCaWQYASABKAlSAmlk');
@$core.Deprecated('Use queryEscrowResponseDescriptor instead')
const QueryEscrowResponse$json = const {
  '1': 'QueryEscrowResponse',
  '2': const [
    const {'1': 'escrow', '3': 1, '4': 3, '5': 11, '6': '.cosmos.base.v1beta1.Coin', '8': const {}, '10': 'escrow'},
  ],
};

/// Descriptor for `QueryEscrowResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryEscrowResponseDescriptor = $convert.base64Decode('ChNRdWVyeUVzY3Jvd1Jlc3BvbnNlEmMKBmVzY3JvdxgBIAMoCzIZLmNvc21vcy5iYXNlLnYxYmV0YTEuQ29pbkIwyN4fAKrfHyhnaXRodWIuY29tL2Nvc21vcy9jb3Ntb3Mtc2RrL3R5cGVzLkNvaW5zUgZlc2Nyb3c=');
...
final $typed_data.Uint8List queryAccessRequestDescriptor = $convert.base64Decode('ChJRdWVyeUFjY2Vzc1JlcXVlc3QSDgoCaWQYASABKAlSAmlk');
@$core.Deprecated('Use queryAccessResponseDescriptor instead')
const QueryAccessResponse$json = const {
  '1': 'QueryAccessResponse',
  '2': const [
    const {'1': 'accounts', '3': 1, '4': 3, '5': 11, '6': '.provenance.marker.v1.AccessGrant', '8': const {}, '10': 'accounts'},
  ],
};

/// Descriptor for `QueryAccessResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryAccessResponseDescriptor = $convert.base64Decode('ChNRdWVyeUFjY2Vzc1Jlc3BvbnNlEkMKCGFjY291bnRzGAEgAygLMiEucHJvdmVuYW5jZS5tYXJrZXIudjEuQWNjZXNzR3JhbnRCBMjeHwBSCGFjY291bnRz');
