...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.mint.v1beta1'), createEmptyInstance: create)
    ..aOM<$0.Minter>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minter', subBuilder: $0.Minter.create)
    ..aOM<$0.Params>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params', subBuilder: $0.Params.create)
  ...
  @$pb.TagNumber(1)
  set minter($0.Minter v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set params($0.Params v) { setField(2, v); }
  @$pb.TagNumber(2)
