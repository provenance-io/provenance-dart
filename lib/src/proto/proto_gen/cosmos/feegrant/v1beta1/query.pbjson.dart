...
final $typed_data.Uint8List queryAllowanceRequestDescriptor = $convert.base64Decode(
    'ChVRdWVyeUFsbG93YW5jZVJlcXVlc3QSMgoHZ3JhbnRlchgBIAEoCUIY0rQtFGNvc21vcy5BZGRyZXNzU3RyaW5nUgdncmFudGVyEjIKB2dyYW50ZWUYAiABKAlCGNK0LRRjb3Ntb3MuQWRkcmVzc1N0cmluZ1IHZ3JhbnRlZQ==');
...
final $typed_data.Uint8List queryAllowancesRequestDescriptor =
    $convert.base64Decode(
        'ChZRdWVyeUFsbG93YW5jZXNSZXF1ZXN0EjIKB2dyYW50ZWUYASABKAlCGNK0LRRjb3Ntb3MuQWRkcmVzc1N0cmluZ1IHZ3JhbnRlZRJGCgpwYWdpbmF0aW9uGAIgASgLMiYuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVxdWVzdFIKcGFnaW5hdGlvbg==');
...
final $typed_data.Uint8List queryAllowancesByGranterRequestDescriptor =
    $convert.base64Decode(
        'Ch9RdWVyeUFsbG93YW5jZXNCeUdyYW50ZXJSZXF1ZXN0EjIKB2dyYW50ZXIYASABKAlCGNK0LRRjb3Ntb3MuQWRkcmVzc1N0cmluZ1IHZ3JhbnRlchJGCgpwYWdpbmF0aW9uGAIgASgLMiYuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVxdWVzdFIKcGFnaW5hdGlvbg==');
...
final $typed_data.Uint8List queryAllowancesByGranterResponseDescriptor =
    $convert.base64Decode(
        'CiBRdWVyeUFsbG93YW5jZXNCeUdyYW50ZXJSZXNwb25zZRI+CgphbGxvd2FuY2VzGAEgAygLMh4uY29zbW9zLmZlZWdyYW50LnYxYmV0YTEuR3JhbnRSCmFsbG93YW5jZXMSRwoKcGFnaW5hdGlvbhgCIAEoCzInLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlc3BvbnNlUgpwYWdpbmF0aW9u');
