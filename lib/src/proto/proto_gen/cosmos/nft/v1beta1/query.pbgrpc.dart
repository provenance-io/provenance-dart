...
class QueryClient extends $grpc.Client {
  ...
  static final _$owner =
      $grpc.ClientMethod<$0.QueryOwnerRequest, $0.QueryOwnerResponse>(
          '/cosmos.nft.v1beta1.Query/Owner',
          ($0.QueryOwnerRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.QueryOwnerResponse.fromBuffer(value));
  ...
  static final _$nFTs =
      $grpc.ClientMethod<$0.QueryNFTsRequest, $0.QueryNFTsResponse>(
          '/cosmos.nft.v1beta1.Query/NFTs',
          ($0.QueryNFTsRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.QueryNFTsResponse.fromBuffer(value));
  static final _$nFT =
      $grpc.ClientMethod<$0.QueryNFTRequest, $0.QueryNFTResponse>(
          '/cosmos.nft.v1beta1.Query/NFT',
          ($0.QueryNFTRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.QueryNFTResponse.fromBuffer(value));
  static final _$class =
      $grpc.ClientMethod<$0.QueryClassRequest, $0.QueryClassResponse>(
          '/cosmos.nft.v1beta1.Query/Class',
          ($0.QueryClassRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.QueryClassResponse.fromBuffer(value));
  static final _$classes =
      $grpc.ClientMethod<$0.QueryClassesRequest, $0.QueryClassesResponse>(
          '/cosmos.nft.v1beta1.Query/Classes',
          ($0.QueryClassesRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.QueryClassesResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.QueryOwnerResponse> owner(
      $0.QueryOwnerRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.QueryNFTsResponse> nFTs($0.QueryNFTsRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$nFTs, request, options: options);
  }

  $grpc.ResponseFuture<$0.QueryNFTResponse> nFT($0.QueryNFTRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.QueryClassesResponse> classes(
      $0.QueryClassesRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.QueryClassesRequest, $0.QueryClassesResponse>(
            'Classes',
            classes_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.QueryClassesRequest.fromBuffer(value),
  ...
  $async.Future<$0.QueryOwnerResponse> owner_Pre($grpc.ServiceCall call,
      $async.Future<$0.QueryOwnerRequest> request) async {
  ...
  $async.Future<$0.QueryNFTsResponse> nFTs_Pre($grpc.ServiceCall call,
      $async.Future<$0.QueryNFTsRequest> request) async {
    return nFTs(call, await request);
  }

  $async.Future<$0.QueryNFTResponse> nFT_Pre(
      $grpc.ServiceCall call, $async.Future<$0.QueryNFTRequest> request) async {
  ...
  $async.Future<$0.QueryClassesResponse> classes_Pre($grpc.ServiceCall call,
      $async.Future<$0.QueryClassesRequest> request) async {
  ...
  $async.Future<$0.QueryOwnerResponse> owner(
      $grpc.ServiceCall call, $0.QueryOwnerRequest request);
  $async.Future<$0.QuerySupplyResponse> supply(
      $grpc.ServiceCall call, $0.QuerySupplyRequest request);
  $async.Future<$0.QueryNFTsResponse> nFTs(
