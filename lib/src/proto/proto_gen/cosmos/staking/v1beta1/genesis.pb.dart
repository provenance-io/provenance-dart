...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.staking.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$0.Validator>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validators', $pb.PbFieldType.PM, subBuilder: $0.Validator.create)
    ..pc<$0.Delegation>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'delegations', $pb.PbFieldType.PM, subBuilder: $0.Delegation.create)
    ..pc<$0.UnbondingDelegation>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unbondingDelegations', $pb.PbFieldType.PM, subBuilder: $0.UnbondingDelegation.create)
    ..pc<$0.Redelegation>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'redelegations', $pb.PbFieldType.PM, subBuilder: $0.Redelegation.create)
