...
import 'authz.pb.dart' as $0;

/// GenesisState defines the authz module's genesis state.
class GenesisState extends $pb.GeneratedMessage {
  factory GenesisState({
    $core.Iterable<$0.GrantAuthorization>? authorization,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$0.GrantAuthorization>(
        1, _omitFieldNames ? '' : 'authorization', $pb.PbFieldType.PM,
        subBuilder: $0.GrantAuthorization.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$0.GrantAuthorization> get authorization => $_getList(0);
}
