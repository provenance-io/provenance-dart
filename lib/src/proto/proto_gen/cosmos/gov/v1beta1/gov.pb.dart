...
class Proposal extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Proposal', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.gov.v1beta1'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposalId', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$1.Any>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'content', subBuilder: $1.Any.create)
    ...
    ..aOM<$2.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'depositEndTime', subBuilder: $2.Timestamp.create)
    ..pc<$0.Coin>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalDeposit', $pb.PbFieldType.PM, subBuilder: $0.Coin.create)
    ..aOM<$2.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'votingStartTime', subBuilder: $2.Timestamp.create)
    ..aOM<$2.Timestamp>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'votingEndTime', subBuilder: $2.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set content($1.Any v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(6)
  set depositEndTime($2.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(8)
  set votingStartTime($2.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set votingEndTime($2.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class DepositParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DepositParams', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.gov.v1beta1'), createEmptyInstance: create)
    ..pc<$0.Coin>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minDeposit', $pb.PbFieldType.PM, subBuilder: $0.Coin.create)
    ..aOM<$3.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxDepositPeriod', subBuilder: $3.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set maxDepositPeriod($3.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
