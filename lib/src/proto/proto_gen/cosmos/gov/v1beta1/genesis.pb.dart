...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.gov.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$0.Deposit>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deposits', $pb.PbFieldType.PM, subBuilder: $0.Deposit.create)
    ..pc<$0.Vote>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'votes', $pb.PbFieldType.PM, subBuilder: $0.Vote.create)
    ..pc<$0.Proposal>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposals', $pb.PbFieldType.PM, subBuilder: $0.Proposal.create)
    ..aOM<$0.DepositParams>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'depositParams', subBuilder: $0.DepositParams.create)
    ..aOM<$0.VotingParams>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'votingParams', subBuilder: $0.VotingParams.create)
    ..aOM<$0.TallyParams>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tallyParams', subBuilder: $0.TallyParams.create)
  ...
  @$pb.TagNumber(5)
  set depositParams($0.DepositParams v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set votingParams($0.VotingParams v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set tallyParams($0.TallyParams v) { setField(7, v); }
  @$pb.TagNumber(7)
