...
final $typed_data.Uint8List packetMsgDescriptor = $convert.base64Decode(
    'CglQYWNrZXRNc2cSLAoKY2hhbm5lbF9pZBgBIAEoBUIN4t4fCUNoYW5uZWxJRFIJY2hhbm5lbElkEhkKA2VvZhgCIAEoCEIH4t4fA0VPRlIDZW9mEhIKBGRhdGEYAyABKAxSBGRhdGE=');
...
final $typed_data.Uint8List packetDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List authSigMessageDescriptor = $convert.base64Decode(
    'Cg5BdXRoU2lnTWVzc2FnZRI7CgdwdWJfa2V5GAEgASgLMhwudGVuZGVybWludC5jcnlwdG8uUHVibGljS2V5QgTI3h8AUgZwdWJLZXkSEAoDc2lnGAIgASgMUgNzaWc=');
