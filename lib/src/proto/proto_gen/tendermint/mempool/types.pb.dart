...
class Txs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Txs', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.mempool'), createEmptyInstance: create)
...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Message', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.mempool'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<Txs>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'txs', subBuilder: Txs.create)
    ..hasRequiredFields = false
  ;
