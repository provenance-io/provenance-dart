...
class ABCIResponses extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ABCIResponses', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.state'), createEmptyInstance: create)
    ..pc<$0.ResponseDeliverTx>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deliverTxs', $pb.PbFieldType.PM, subBuilder: $0.ResponseDeliverTx.create)
    ..aOM<$0.ResponseEndBlock>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endBlock', subBuilder: $0.ResponseEndBlock.create)
    ..aOM<$0.ResponseBeginBlock>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'beginBlock', subBuilder: $0.ResponseBeginBlock.create)
  ...
  factory ABCIResponses.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ABCIResponses.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  ...
  'Will be removed in next major version')
  ABCIResponses copyWith(void Function(ABCIResponses) updates) => super.copyWith((message) => updates(message as ABCIResponses)) as ABCIResponses; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ABCIResponses create() => ABCIResponses._();
  ABCIResponses createEmptyInstance() => create();
  static $pb.PbList<ABCIResponses> createRepeated() => $pb.PbList<ABCIResponses>();
  @$core.pragma('dart2js:noInline')
  static ABCIResponses getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ABCIResponses>(create);
  ...
  @$pb.TagNumber(2)
  set endBlock($0.ResponseEndBlock v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set beginBlock($0.ResponseBeginBlock v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class ValidatorsInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValidatorsInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.state'), createEmptyInstance: create)
    ..aOM<$1.ValidatorSet>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validatorSet', subBuilder: $1.ValidatorSet.create)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastHeightChanged')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ValidatorsInfo copyWith(void Function(ValidatorsInfo) updates) => super.copyWith((message) => updates(message as ValidatorsInfo)) as ValidatorsInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set validatorSet($1.ValidatorSet v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ConsensusParamsInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConsensusParamsInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.state'), createEmptyInstance: create)
    ..aOM<$2.ConsensusParams>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusParams', subBuilder: $2.ConsensusParams.create)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastHeightChanged')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConsensusParamsInfo copyWith(void Function(ConsensusParamsInfo) updates) => super.copyWith((message) => updates(message as ConsensusParamsInfo)) as ConsensusParamsInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Version extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Version', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.state'), createEmptyInstance: create)
    ..aOM<$3.Consensus>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensus', subBuilder: $3.Consensus.create)
  ...
  @$pb.TagNumber(1)
  set consensus($3.Consensus v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class State extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'State', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.state'), createEmptyInstance: create)
    ...
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastBlockHeight')
    ..aOM<$4.BlockID>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastBlockId', subBuilder: $4.BlockID.create)
    ..aOM<$5.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastBlockTime', subBuilder: $5.Timestamp.create)
    ..aOM<$1.ValidatorSet>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextValidators', subBuilder: $1.ValidatorSet.create)
    ..aOM<$1.ValidatorSet>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validators', subBuilder: $1.ValidatorSet.create)
    ..aOM<$1.ValidatorSet>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastValidators', subBuilder: $1.ValidatorSet.create)
    ..aInt64(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastHeightValidatorsChanged')
    ..aOM<$2.ConsensusParams>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusParams', subBuilder: $2.ConsensusParams.create)
    ..aInt64(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastHeightConsensusParamsChanged')
    ...
    ..aInt64(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'initialHeight')
    ..hasRequiredFields = false
  ;
  ...
  factory State({
    ...
    if (lastHeightConsensusParamsChanged != null) {
      _result.lastHeightConsensusParamsChanged = lastHeightConsensusParamsChanged;
    }
  ...
  @$pb.TagNumber(4)
  set lastBlockId($4.BlockID v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set lastBlockTime($5.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set nextValidators($1.ValidatorSet v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set validators($1.ValidatorSet v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set lastValidators($1.ValidatorSet v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  set consensusParams($2.ConsensusParams v) { setField(10, v); }
  @$pb.TagNumber(10)
