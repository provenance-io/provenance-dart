...
class EventDataRoundState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventDataRoundState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.types'), createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'step')
  ...
  'Will be removed in next major version')
  EventDataRoundState copyWith(void Function(EventDataRoundState) updates) => super.copyWith((message) => updates(message as EventDataRoundState)) as EventDataRoundState; // ignore: deprecated_member_use
