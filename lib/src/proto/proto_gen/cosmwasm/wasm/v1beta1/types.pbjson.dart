...
const AccessTypeParam$json = const {
  '1': 'AccessTypeParam',
  '2': const [
    const {'1': 'value', '3': 1, '4': 1, '5': 14, '6': '.cosmwasm.wasm.v1beta1.AccessType', '8': const {}, '10': 'value'},
  ],
  '7': const {},
};

/// Descriptor for `AccessTypeParam`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List accessTypeParamDescriptor = $convert.base64Decode('Cg9BY2Nlc3NUeXBlUGFyYW0SSQoFdmFsdWUYASABKA4yIS5jb3Ntd2FzbS53YXNtLnYxYmV0YTEuQWNjZXNzVHlwZUIQ8t4fDHlhbWw6InZhbHVlIlIFdmFsdWU6BJigHwE=');
@$core.Deprecated('Use accessConfigDescriptor instead')
const AccessConfig$json = const {
  '1': 'AccessConfig',
  '2': const [
    const {'1': 'permission', '3': 1, '4': 1, '5': 14, '6': '.cosmwasm.wasm.v1beta1.AccessType', '8': const {}, '10': 'permission'},
...
final $typed_data.Uint8List accessConfigDescriptor = $convert.base64Decode('CgxBY2Nlc3NDb25maWcSWAoKcGVybWlzc2lvbhgBIAEoDjIhLmNvc213YXNtLndhc20udjFiZXRhMS5BY2Nlc3NUeXBlQhXy3h8ReWFtbDoicGVybWlzc2lvbiJSCnBlcm1pc3Npb24SLAoHYWRkcmVzcxgCIAEoCUIS8t4fDnlhbWw6ImFkZHJlc3MiUgdhZGRyZXNzOgSYoB8B');
@$core.Deprecated('Use paramsDescriptor instead')
const Params$json = const {
  '1': 'Params',
  '2': const [
    const {'1': 'code_upload_access', '3': 1, '4': 1, '5': 11, '6': '.cosmwasm.wasm.v1beta1.AccessConfig', '8': const {}, '10': 'codeUploadAccess'},
    const {'1': 'instantiate_default_permission', '3': 2, '4': 1, '5': 14, '6': '.cosmwasm.wasm.v1beta1.AccessType', '8': const {}, '10': 'instantiateDefaultPermission'},
...
final $typed_data.Uint8List paramsDescriptor = $convert.base64Decode('');
...
const CodeInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'instantiate_config', '3': 5, '4': 1, '5': 11, '6': '.cosmwasm.wasm.v1beta1.AccessConfig', '8': const {}, '10': 'instantiateConfig'},
  ],
};

/// Descriptor for `CodeInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List codeInfoDescriptor = $convert.base64Decode('');
...
const ContractInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'created', '3': 5, '4': 1, '5': 11, '6': '.cosmwasm.wasm.v1beta1.AbsoluteTxPosition', '10': 'created'},
...
final $typed_data.Uint8List contractInfoDescriptor = $convert.base64Decode('');
...
const ContractCodeHistoryEntry$json = const {
  ...
  '2': const [
    const {'1': 'operation', '3': 1, '4': 1, '5': 14, '6': '.cosmwasm.wasm.v1beta1.ContractCodeHistoryOperationType', '10': 'operation'},
    const {'1': 'code_id', '3': 2, '4': 1, '5': 4, '8': const {}, '10': 'codeId'},
    const {'1': 'updated', '3': 3, '4': 1, '5': 11, '6': '.cosmwasm.wasm.v1beta1.AbsoluteTxPosition', '10': 'updated'},
...
final $typed_data.Uint8List contractCodeHistoryEntryDescriptor = $convert.base64Decode('');
