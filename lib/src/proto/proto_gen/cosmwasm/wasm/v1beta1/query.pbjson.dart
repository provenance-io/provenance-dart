...
final $typed_data.Uint8List queryContractInfoResponseDescriptor = $convert.base64Decode('ChlRdWVyeUNvbnRyYWN0SW5mb1Jlc3BvbnNlEhgKB2FkZHJlc3MYASABKAlSB2FkZHJlc3MSVgoNY29udHJhY3RfaW5mbxgCIAEoCzIjLmNvc213YXNtLndhc20udjFiZXRhMS5Db250cmFjdEluZm9CDNDeHwHI3h8A6t4fAFIMY29udHJhY3RJbmZvOgTooB8B');
...
const QueryContractHistoryResponse$json = const {
  ...
  '2': const [
    const {'1': 'entries', '3': 1, '4': 3, '5': 11, '6': '.cosmwasm.wasm.v1beta1.ContractCodeHistoryEntry', '8': const {}, '10': 'entries'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryContractHistoryResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryContractHistoryResponseDescriptor = $convert.base64Decode('ChxRdWVyeUNvbnRyYWN0SGlzdG9yeVJlc3BvbnNlEk8KB2VudHJpZXMYASADKAsyLy5jb3Ntd2FzbS53YXNtLnYxYmV0YTEuQ29udHJhY3RDb2RlSGlzdG9yeUVudHJ5QgTI3h8AUgdlbnRyaWVzEkcKCnBhZ2luYXRpb24YAiABKAsyJy5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXNwb25zZVIKcGFnaW5hdGlvbg==');
...
const QueryAllContractStateResponse$json = const {
  ...
  '2': const [
    const {'1': 'models', '3': 1, '4': 3, '5': 11, '6': '.cosmwasm.wasm.v1beta1.Model', '8': const {}, '10': 'models'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryAllContractStateResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryAllContractStateResponseDescriptor = $convert.base64Decode('Ch1RdWVyeUFsbENvbnRyYWN0U3RhdGVSZXNwb25zZRI6CgZtb2RlbHMYASADKAsyHC5jb3Ntd2FzbS53YXNtLnYxYmV0YTEuTW9kZWxCBMjeHwBSBm1vZGVscxJHCgpwYWdpbmF0aW9uGAIgASgLMicuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVzcG9uc2VSCnBhZ2luYXRpb24=');
...
final $typed_data.Uint8List querySmartContractStateRequestDescriptor = $convert.base64Decode('Ch5RdWVyeVNtYXJ0Q29udHJhY3RTdGF0ZVJlcXVlc3QSGAoHYWRkcmVzcxgBIAEoCVIHYWRkcmVzcxIdCgpxdWVyeV9kYXRhGAIgASgMUglxdWVyeURhdGE=');
...
final $typed_data.Uint8List querySmartContractStateResponseDescriptor = $convert.base64Decode('Ch9RdWVyeVNtYXJ0Q29udHJhY3RTdGF0ZVJlc3BvbnNlEjAKBGRhdGEYASABKAxCHPreHxhlbmNvZGluZy9qc29uLlJhd01lc3NhZ2VSBGRhdGE=');
...
const QueryCodeResponse$json = const {
  '1': 'QueryCodeResponse',
  '2': const [
    const {'1': 'code_info', '3': 1, '4': 1, '5': 11, '6': '.cosmwasm.wasm.v1beta1.CodeInfoResponse', '8': const {}, '10': 'codeInfo'},
...
final $typed_data.Uint8List queryCodeResponseDescriptor = $convert.base64Decode('ChFRdWVyeUNvZGVSZXNwb25zZRJOCgljb2RlX2luZm8YASABKAsyJy5jb3Ntd2FzbS53YXNtLnYxYmV0YTEuQ29kZUluZm9SZXNwb25zZUII0N4fAereHwBSCGNvZGVJbmZvEhwKBGRhdGEYAiABKAxCCOreHwRkYXRhUgRkYXRhOgTooB8B');
...
const QueryCodesResponse$json = const {
  ...
  '2': const [
    const {'1': 'code_infos', '3': 1, '4': 3, '5': 11, '6': '.cosmwasm.wasm.v1beta1.CodeInfoResponse', '8': const {}, '10': 'codeInfos'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryCodesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryCodesResponseDescriptor = $convert.base64Decode('ChJRdWVyeUNvZGVzUmVzcG9uc2USTAoKY29kZV9pbmZvcxgBIAMoCzInLmNvc213YXNtLndhc20udjFiZXRhMS5Db2RlSW5mb1Jlc3BvbnNlQgTI3h8AUgljb2RlSW5mb3MSRwoKcGFnaW5hdGlvbhgCIAEoCzInLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlc3BvbnNlUgpwYWdpbmF0aW9u');
