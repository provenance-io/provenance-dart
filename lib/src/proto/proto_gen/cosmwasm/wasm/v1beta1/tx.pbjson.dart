...
final $typed_data.Uint8List msgStoreCodeDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List msgStoreCodeResponseDescriptor = $convert.base64Decode(
    'ChRNc2dTdG9yZUNvZGVSZXNwb25zZRIjCgdjb2RlX2lkGAEgASgEQgri3h8GQ29kZUlEUgZjb2RlSWQ=');
...
final $typed_data.Uint8List msgInstantiateContractDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List msgInstantiateContractResponseDescriptor =
    $convert.base64Decode(
        'Ch5Nc2dJbnN0YW50aWF0ZUNvbnRyYWN0UmVzcG9uc2USGAoHYWRkcmVzcxgBIAEoCVIHYWRkcmVzcxISCgRkYXRhGAIgASgMUgRkYXRh');
...
final $typed_data.Uint8List msgMigrateContractDescriptor = $convert.base64Decode(
    'ChJNc2dNaWdyYXRlQ29udHJhY3QSFgoGc2VuZGVyGAEgASgJUgZzZW5kZXISGgoIY29udHJhY3QYAiABKAlSCGNvbnRyYWN0EiMKB2NvZGVfaWQYAyABKARCCuLeHwZDb2RlSURSBmNvZGVJZBIfCgttaWdyYXRlX21zZxgEIAEoDFIKbWlncmF0ZU1zZw==');
...
final $typed_data.Uint8List msgUpdateAdminDescriptor = $convert.base64Decode(
    'Cg5Nc2dVcGRhdGVBZG1pbhIWCgZzZW5kZXIYASABKAlSBnNlbmRlchIbCgluZXdfYWRtaW4YAiABKAlSCG5ld0FkbWluEhoKCGNvbnRyYWN0GAMgASgJUghjb250cmFjdA==');
...
final $typed_data.Uint8List msgClearAdminDescriptor = $convert.base64Decode(
    'Cg1Nc2dDbGVhckFkbWluEhYKBnNlbmRlchgBIAEoCVIGc2VuZGVyEhoKCGNvbnRyYWN0GAMgASgJUghjb250cmFjdA==');
