...
class AccessType extends $pb.ProtobufEnum {
  static const AccessType ACCESS_TYPE_UNSPECIFIED = AccessType._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ACCESS_TYPE_UNSPECIFIED');
  static const AccessType ACCESS_TYPE_NOBODY = AccessType._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ACCESS_TYPE_NOBODY');
  static const AccessType ACCESS_TYPE_ONLY_ADDRESS = AccessType._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ACCESS_TYPE_ONLY_ADDRESS');
  static const AccessType ACCESS_TYPE_EVERYBODY = AccessType._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
