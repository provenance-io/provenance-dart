...
class _RipEmd160Data {
  ...
  FF(_RipIndex aIndex, _RipIndex bIndex, _RipIndex cIndex, _RipIndex dIndex,
          _RipIndex eIndex, int x, int s) =>
      _worker(aIndex, bIndex, cIndex, dIndex, eIndex, x, s, F);

  GG(_RipIndex aIndex, _RipIndex bIndex, _RipIndex cIndex, _RipIndex dIndex,
          _RipIndex eIndex, int x, int s) =>
      _worker(aIndex, bIndex, cIndex, dIndex, eIndex, x, s, G, 0x5A827999);

  HH(_RipIndex aIndex, _RipIndex bIndex, _RipIndex cIndex, _RipIndex dIndex,
          _RipIndex eIndex, int x, int s) =>
      _worker(aIndex, bIndex, cIndex, dIndex, eIndex, x, s, H, 0x6ED9EBA1);

  II(_RipIndex aIndex, _RipIndex bIndex, _RipIndex cIndex, _RipIndex dIndex,
          _RipIndex eIndex, int x, int s) =>
      _worker(aIndex, bIndex, cIndex, dIndex, eIndex, x, s, I, 0x8F1BBCDC);

  JJ(_RipIndex aIndex, _RipIndex bIndex, _RipIndex cIndex, _RipIndex dIndex,
          _RipIndex eIndex, int x, int s) =>
      _worker(aIndex, bIndex, cIndex, dIndex, eIndex, x, s, J, 0xA953FD4E);

  FFF(_RipIndex aIndex, _RipIndex bIndex, _RipIndex cIndex, _RipIndex dIndex,
          _RipIndex eIndex, int x, int s) =>
      _worker(aIndex, bIndex, cIndex, dIndex, eIndex, x, s, F);

  GGG(_RipIndex aIndex, _RipIndex bIndex, _RipIndex cIndex, _RipIndex dIndex,
          _RipIndex eIndex, int x, int s) =>
      _worker(aIndex, bIndex, cIndex, dIndex, eIndex, x, s, G, 0x7A6D76E9);

  HHH(_RipIndex aIndex, _RipIndex bIndex, _RipIndex cIndex, _RipIndex dIndex,
          _RipIndex eIndex, int x, int s) =>
      _worker(aIndex, bIndex, cIndex, dIndex, eIndex, x, s, H, 0x6D703EF3);

  III(_RipIndex aIndex, _RipIndex bIndex, _RipIndex cIndex, _RipIndex dIndex,
          _RipIndex eIndex, int x, int s) =>
      _worker(aIndex, bIndex, cIndex, dIndex, eIndex, x, s, I, 0x5C4DD124);

  JJJ(_RipIndex aIndex, _RipIndex bIndex, _RipIndex cIndex, _RipIndex dIndex,
          _RipIndex eIndex, int x, int s) =>
      _worker(aIndex, bIndex, cIndex, dIndex, eIndex, x, s, J, 0x50A28BE6);
